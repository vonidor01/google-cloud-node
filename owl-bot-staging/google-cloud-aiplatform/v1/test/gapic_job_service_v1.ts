...
describe('v1.JobServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new jobserviceModule.v1.JobServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new jobserviceModule.v1.JobServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new jobserviceModule.v1.JobServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new jobserviceModule.v1.JobServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createCustomJob', () => {
        it('invokes createCustomJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateCustomJobRequest', ['parent']);
        ...
        it('invokes createCustomJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCustomJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ICustomJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getCustomJob', () => {
        it('invokes getCustomJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetCustomJobRequest', ['name']);
    ...
    describe('cancelCustomJob', () => {
        it('invokes cancelCustomJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CancelCustomJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createDataLabelingJob', () => {
        it('invokes createDataLabelingJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateDataLabelingJobRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createDataLabelingJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createDataLabelingJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IDataLabelingJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getDataLabelingJob', () => {
        it('invokes getDataLabelingJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetDataLabelingJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.DataLabelingJob()
    ...
    describe('cancelDataLabelingJob', () => {
        it('invokes cancelDataLabelingJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CancelDataLabelingJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createHyperparameterTuningJob', () => {
        it('invokes createHyperparameterTuningJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateHyperparameterTuningJobRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createHyperparameterTuningJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createHyperparameterTuningJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IHyperparameterTuningJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getHyperparameterTuningJob', () => {
        it('invokes getHyperparameterTuningJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetHyperparameterTuningJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.HyperparameterTuningJob()
    ...
    describe('cancelHyperparameterTuningJob', () => {
        it('invokes cancelHyperparameterTuningJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CancelHyperparameterTuningJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createNasJob', () => {
        it('invokes createNasJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CreateNasJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateNasJobRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.NasJob()
            );
        ...
        it('invokes createNasJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createNasJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.INasJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getNasJob', () => {
        it('invokes getNasJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.GetNasJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetNasJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.NasJob()
    ...
    describe('cancelNasJob', () => {
        it('invokes cancelNasJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CancelNasJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CancelNasJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getNasTrialDetail', () => {
        it('invokes getNasTrialDetail without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.GetNasTrialDetailRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetNasTrialDetailRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.NasTrialDetail()
            );
        ...
        it('invokes getNasTrialDetail without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getNasTrialDetail(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.INasTrialDetail|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createBatchPredictionJob', () => {
        it('invokes createBatchPredictionJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateBatchPredictionJobRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createBatchPredictionJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createBatchPredictionJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IBatchPredictionJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBatchPredictionJob', () => {
        it('invokes getBatchPredictionJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetBatchPredictionJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.BatchPredictionJob()
    ...
    describe('cancelBatchPredictionJob', () => {
        it('invokes cancelBatchPredictionJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CancelBatchPredictionJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createModelDeploymentMonitoringJob', () => {
        it('invokes createModelDeploymentMonitoringJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateModelDeploymentMonitoringJobRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createModelDeploymentMonitoringJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createModelDeploymentMonitoringJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IModelDeploymentMonitoringJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getModelDeploymentMonitoringJob', () => {
        it('invokes getModelDeploymentMonitoringJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetModelDeploymentMonitoringJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ModelDeploymentMonitoringJob()
    ...
    describe('pauseModelDeploymentMonitoringJob', () => {
        it('invokes pauseModelDeploymentMonitoringJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.PauseModelDeploymentMonitoringJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('resumeModelDeploymentMonitoringJob', () => {
        it('invokes resumeModelDeploymentMonitoringJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ResumeModelDeploymentMonitoringJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('deleteCustomJob', () => {
        it('invokes deleteCustomJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteCustomJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('deleteDataLabelingJob', () => {
        it('invokes deleteDataLabelingJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteDataLabelingJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteHyperparameterTuningJob', () => {
        it('invokes deleteHyperparameterTuningJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteHyperparameterTuningJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteNasJob', () => {
        it('invokes deleteNasJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.DeleteNasJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteNasJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteBatchPredictionJob', () => {
        it('invokes deleteBatchPredictionJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteBatchPredictionJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateModelDeploymentMonitoringJob', () => {
        it('invokes updateModelDeploymentMonitoringJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UpdateModelDeploymentMonitoringJobRequest', ['modelDeploymentMonitoringJob', 'name']);
        ...
        it('invokes updateModelDeploymentMonitoringJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateModelDeploymentMonitoringJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IModelDeploymentMonitoringJob, protos.google.cloud.aiplatform.v1.IUpdateModelDeploymentMonitoringJobOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IModelDeploymentMonitoringJob, protos.google.cloud.aiplatform.v1.IUpdateModelDeploymentMonitoringJobOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteModelDeploymentMonitoringJob', () => {
        it('invokes deleteModelDeploymentMonitoringJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteModelDeploymentMonitoringJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listCustomJobs', () => {
        it('invokes listCustomJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListCustomJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.CustomJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.CustomJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.CustomJob()),
            ];
        ...
        it('invokes listCustomJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.CustomJob) => {
    ...
    describe('listDataLabelingJobs', () => {
        it('invokes listDataLabelingJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListDataLabelingJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.DataLabelingJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.DataLabelingJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.DataLabelingJob()),
            ];
        ...
        it('invokes listDataLabelingJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.DataLabelingJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listHyperparameterTuningJobs', () => {
        it('invokes listHyperparameterTuningJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListHyperparameterTuningJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.HyperparameterTuningJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.HyperparameterTuningJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.HyperparameterTuningJob()),
            ];
        ...
        it('invokes listHyperparameterTuningJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.HyperparameterTuningJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listNasJobs', () => {
        it('invokes listNasJobs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ListNasJobsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListNasJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.NasJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.NasJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.NasJob()),
            ];
        ...
        it('invokes listNasJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.NasJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.NasJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listNasJobs without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1.INasJob[] = [];
    ...
    describe('listNasTrialDetails', () => {
        it('invokes listNasTrialDetails without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListNasTrialDetailsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.NasTrialDetail()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.NasTrialDetail()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.NasTrialDetail()),
            ];
        ...
        it('invokes listNasTrialDetailsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.NasTrialDetail[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.NasTrialDetail) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listBatchPredictionJobs', () => {
        it('invokes listBatchPredictionJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListBatchPredictionJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.BatchPredictionJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.BatchPredictionJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.BatchPredictionJob()),
            ];
        ...
        it('invokes listBatchPredictionJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.BatchPredictionJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('searchModelDeploymentMonitoringStatsAnomalies', () => {
        it('invokes searchModelDeploymentMonitoringStatsAnomalies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.SearchModelDeploymentMonitoringStatsAnomaliesRequest', ['modelDeploymentMonitoringJob']);
            ...
            const expectedHeaderRequestParams = `model_deployment_monitoring_job=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.ModelMonitoringStatsAnomalies()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.ModelMonitoringStatsAnomalies()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.ModelMonitoringStatsAnomalies()),
            ];
        ...
        it('invokes searchModelDeploymentMonitoringStatsAnomalies without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.searchModelDeploymentMonitoringStatsAnomalies(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IModelMonitoringStatsAnomalies[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchModelDeploymentMonitoringStatsAnomaliesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.ModelMonitoringStatsAnomalies) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listModelDeploymentMonitoringJobs', () => {
        it('invokes listModelDeploymentMonitoringJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListModelDeploymentMonitoringJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.ModelDeploymentMonitoringJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.ModelDeploymentMonitoringJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.ModelDeploymentMonitoringJob()),
            ];
        ...
        it('invokes listModelDeploymentMonitoringJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.ModelDeploymentMonitoringJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
