...
describe('v1.NotebookServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new notebookserviceModule.v1.NotebookServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new notebookserviceModule.v1.NotebookServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new notebookserviceModule.v1.NotebookServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new notebookserviceModule.v1.NotebookServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
        ...
        it('invokes getNotebookRuntimeTemplate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getNotebookRuntimeTemplate(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.INotebookRuntimeTemplate|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getNotebookRuntime without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getNotebookRuntime(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.INotebookRuntime|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getNotebookExecutionJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getNotebookExecutionJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.INotebookExecutionJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createNotebookRuntimeTemplate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createNotebookRuntimeTemplate(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.INotebookRuntimeTemplate, protos.google.cloud.aiplatform.v1.ICreateNotebookRuntimeTemplateOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.INotebookRuntimeTemplate, protos.google.cloud.aiplatform.v1.ICreateNotebookRuntimeTemplateOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createNotebookRuntimeTemplate as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes assignNotebookRuntime without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.assignNotebookRuntime(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.INotebookRuntime, protos.google.cloud.aiplatform.v1.IAssignNotebookRuntimeOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.INotebookRuntime, protos.google.cloud.aiplatform.v1.IAssignNotebookRuntimeOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.assignNotebookRuntime as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes upgradeNotebookRuntime without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.upgradeNotebookRuntime(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IUpgradeNotebookRuntimeResponse, protos.google.cloud.aiplatform.v1.IUpgradeNotebookRuntimeOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IUpgradeNotebookRuntimeResponse, protos.google.cloud.aiplatform.v1.IUpgradeNotebookRuntimeOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.upgradeNotebookRuntime as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes startNotebookRuntime without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.startNotebookRuntime(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IStartNotebookRuntimeResponse, protos.google.cloud.aiplatform.v1.IStartNotebookRuntimeOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IStartNotebookRuntimeResponse, protos.google.cloud.aiplatform.v1.IStartNotebookRuntimeOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.startNotebookRuntime as SinonStub)
                .getCall(0).args[0];
    ...
    describe('stopNotebookRuntime', () => {
        it('invokes stopNotebookRuntime without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.StopNotebookRuntimeRequest()
            );
            const defaultValue1 =
        ...
        it('invokes stopNotebookRuntime without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.stopNotebookRuntime(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IStopNotebookRuntimeResponse, protos.google.cloud.aiplatform.v1.IStopNotebookRuntimeOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IStopNotebookRuntimeResponse, protos.google.cloud.aiplatform.v1.IStopNotebookRuntimeOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.stopNotebookRuntime as SinonStub)
                .getCall(0).args[0];
    ...
    describe('createNotebookExecutionJob', () => {
        it('invokes createNotebookExecutionJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CreateNotebookExecutionJobRequest()
            );
            const defaultValue1 =
        ...
        it('invokes createNotebookExecutionJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createNotebookExecutionJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.INotebookExecutionJob, protos.google.cloud.aiplatform.v1.ICreateNotebookExecutionJobOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.INotebookExecutionJob, protos.google.cloud.aiplatform.v1.ICreateNotebookExecutionJobOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createNotebookExecutionJob as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteNotebookExecutionJob', () => {
        it('invokes deleteNotebookExecutionJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.DeleteNotebookExecutionJobRequest()
            );
            const defaultValue1 =
    ...
    describe('listNotebookRuntimeTemplates', () => {
        ...
        it('invokes listNotebookRuntimeTemplatesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.NotebookRuntimeTemplate) => {
    ...
    describe('listNotebookRuntimes', () => {
        ...
        it('invokes listNotebookRuntimesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.NotebookRuntime) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listNotebookExecutionJobs', () => {
        it('invokes listNotebookExecutionJobs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ListNotebookExecutionJobsRequest()
            );
            const defaultValue1 =
        ...
        it('invokes listNotebookExecutionJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.NotebookExecutionJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.NotebookExecutionJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listNotebookExecutionJobs without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1.INotebookExecutionJob[] = [];
