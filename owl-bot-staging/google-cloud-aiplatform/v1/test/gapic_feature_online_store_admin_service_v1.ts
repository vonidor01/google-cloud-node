...
import * as featureonlinestoreadminserviceModule from '../src';
...
describe('v1.FeatureOnlineStoreAdminServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient.port;
            assert(port);
    ...
    describe('getFeatureOnlineStore', () => {
        it('invokes getFeatureOnlineStore without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.GetFeatureOnlineStoreRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetFeatureOnlineStoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.FeatureOnlineStore()
            );
            client.innerApiCalls.getFeatureOnlineStore = stubSimpleCall(expectedResponse);
            const [response] = await client.getFeatureOnlineStore(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFeatureOnlineStore as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getFeatureOnlineStore without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getFeatureOnlineStore = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFeatureOnlineStore(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IFeatureOnlineStore|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFeatureOnlineStore with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getFeatureOnlineStore = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getFeatureOnlineStore with closed client', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('getFeatureView', () => {
        it('invokes getFeatureView without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.GetFeatureViewRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetFeatureViewRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.FeatureView()
            );
            client.innerApiCalls.getFeatureView = stubSimpleCall(expectedResponse);
            const [response] = await client.getFeatureView(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getFeatureView as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFeatureView as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getFeatureView without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getFeatureView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFeatureView(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IFeatureView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFeatureView with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getFeatureView = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getFeatureView with closed client', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('syncFeatureView', () => {
        it('invokes syncFeatureView without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.SyncFeatureViewRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.SyncFeatureViewRequest', ['featureView']);
            request.featureView = defaultValue1;
            const expectedHeaderRequestParams = `feature_view=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.SyncFeatureViewResponse()
            );
            client.innerApiCalls.syncFeatureView = stubSimpleCall(expectedResponse);
            const [response] = await client.syncFeatureView(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.syncFeatureView as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.syncFeatureView as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes syncFeatureView without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.syncFeatureView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.syncFeatureView(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ISyncFeatureViewResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes syncFeatureView with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `feature_view=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.syncFeatureView = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes syncFeatureView with closed client', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('getFeatureViewSync', () => {
        it('invokes getFeatureViewSync without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.GetFeatureViewSyncRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetFeatureViewSyncRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.FeatureViewSync()
            );
            client.innerApiCalls.getFeatureViewSync = stubSimpleCall(expectedResponse);
            const [response] = await client.getFeatureViewSync(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getFeatureViewSync as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFeatureViewSync as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getFeatureViewSync without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getFeatureViewSync = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFeatureViewSync(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IFeatureViewSync|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFeatureViewSync with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getFeatureViewSync = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getFeatureViewSync with closed client', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('createFeatureOnlineStore', () => {
        it('invokes createFeatureOnlineStore without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CreateFeatureOnlineStoreRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateFeatureOnlineStoreRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createFeatureOnlineStore = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createFeatureOnlineStore(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createFeatureOnlineStore as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createFeatureOnlineStore without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createFeatureOnlineStore = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createFeatureOnlineStore(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IFeatureOnlineStore, protos.google.cloud.aiplatform.v1.ICreateFeatureOnlineStoreOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IFeatureOnlineStore, protos.google.cloud.aiplatform.v1.ICreateFeatureOnlineStoreOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createFeatureOnlineStore with call error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createFeatureOnlineStore = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createFeatureOnlineStore(request), expectedError);
            const actualRequest = (client.innerApiCalls.createFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createFeatureOnlineStore as SinonStub)
        ...
        it('invokes createFeatureOnlineStore with LRO error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createFeatureOnlineStore = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createFeatureOnlineStore(request);
        ...
        it('invokes checkCreateFeatureOnlineStoreProgress without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const decodedOperation = await client.checkCreateFeatureOnlineStoreProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkCreateFeatureOnlineStoreProgress with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            await assert.rejects(client.checkCreateFeatureOnlineStoreProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('updateFeatureOnlineStore', () => {
        it('invokes updateFeatureOnlineStore without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.UpdateFeatureOnlineStoreRequest()
            );
            request.featureOnlineStore ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UpdateFeatureOnlineStoreRequest', ['featureOnlineStore', 'name']);
            request.featureOnlineStore.name = defaultValue1;
            const expectedHeaderRequestParams = `feature_online_store.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateFeatureOnlineStore = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateFeatureOnlineStore(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateFeatureOnlineStore as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes updateFeatureOnlineStore without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.updateFeatureOnlineStore = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateFeatureOnlineStore(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IFeatureOnlineStore, protos.google.cloud.aiplatform.v1.IUpdateFeatureOnlineStoreOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IFeatureOnlineStore, protos.google.cloud.aiplatform.v1.IUpdateFeatureOnlineStoreOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes updateFeatureOnlineStore with call error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `feature_online_store.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateFeatureOnlineStore = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateFeatureOnlineStore(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateFeatureOnlineStore as SinonStub)
        ...
        it('invokes updateFeatureOnlineStore with LRO error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `feature_online_store.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateFeatureOnlineStore = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateFeatureOnlineStore(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateFeatureOnlineStoreProgress without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateFeatureOnlineStoreProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkUpdateFeatureOnlineStoreProgress with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateFeatureOnlineStoreProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('deleteFeatureOnlineStore', () => {
        it('invokes deleteFeatureOnlineStore without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.DeleteFeatureOnlineStoreRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteFeatureOnlineStoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteFeatureOnlineStore = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteFeatureOnlineStore(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFeatureOnlineStore as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes deleteFeatureOnlineStore without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deleteFeatureOnlineStore = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteFeatureOnlineStore(
                    request,
                    (err?: Error|null,
        ...
        it('invokes deleteFeatureOnlineStore with call error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFeatureOnlineStore = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteFeatureOnlineStore(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFeatureOnlineStore as SinonStub)
        ...
        it('invokes deleteFeatureOnlineStore with LRO error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFeatureOnlineStore = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteFeatureOnlineStore(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteFeatureOnlineStoreProgress without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteFeatureOnlineStoreProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkDeleteFeatureOnlineStoreProgress with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteFeatureOnlineStoreProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('createFeatureView', () => {
        it('invokes createFeatureView without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CreateFeatureViewRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateFeatureViewRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createFeatureView = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createFeatureView(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFeatureView as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createFeatureView as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createFeatureView without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createFeatureView = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createFeatureView(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IFeatureView, protos.google.cloud.aiplatform.v1.ICreateFeatureViewOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IFeatureView, protos.google.cloud.aiplatform.v1.ICreateFeatureViewOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFeatureView as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createFeatureView with call error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createFeatureView = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createFeatureView(request), expectedError);
            const actualRequest = (client.innerApiCalls.createFeatureView as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createFeatureView as SinonStub)
        ...
        it('invokes createFeatureView with LRO error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createFeatureView = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createFeatureView(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createFeatureView as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateFeatureViewProgress without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateFeatureViewProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkCreateFeatureViewProgress with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateFeatureViewProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('updateFeatureView', () => {
        it('invokes updateFeatureView without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.UpdateFeatureViewRequest()
            );
            request.featureView ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UpdateFeatureViewRequest', ['featureView', 'name']);
            request.featureView.name = defaultValue1;
            const expectedHeaderRequestParams = `feature_view.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateFeatureView = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateFeatureView(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFeatureView as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateFeatureView as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes updateFeatureView without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.updateFeatureView = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateFeatureView(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IFeatureView, protos.google.cloud.aiplatform.v1.IUpdateFeatureViewOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IFeatureView, protos.google.cloud.aiplatform.v1.IUpdateFeatureViewOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFeatureView as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes updateFeatureView with call error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `feature_view.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateFeatureView = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateFeatureView(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateFeatureView as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateFeatureView as SinonStub)
        ...
        it('invokes updateFeatureView with LRO error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `feature_view.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateFeatureView = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateFeatureView(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateFeatureView as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateFeatureViewProgress without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateFeatureViewProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkUpdateFeatureViewProgress with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateFeatureViewProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('deleteFeatureView', () => {
        it('invokes deleteFeatureView without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.DeleteFeatureViewRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteFeatureViewRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteFeatureView = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteFeatureView(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFeatureView as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFeatureView as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes deleteFeatureView without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deleteFeatureView = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteFeatureView(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1.IDeleteOperationMetadata>|null
                    ) => {
        ...
        it('invokes deleteFeatureView with call error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFeatureView = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteFeatureView(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteFeatureView as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFeatureView as SinonStub)
        ...
        it('invokes deleteFeatureView with LRO error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFeatureView = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteFeatureView(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteFeatureView as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteFeatureViewProgress without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteFeatureViewProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkDeleteFeatureViewProgress with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteFeatureViewProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listFeatureOnlineStores', () => {
        it('invokes listFeatureOnlineStores without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ListFeatureOnlineStoresRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListFeatureOnlineStoresRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.FeatureOnlineStore()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.FeatureOnlineStore()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.FeatureOnlineStore()),
            ];
            client.innerApiCalls.listFeatureOnlineStores = stubSimpleCall(expectedResponse);
            const [response] = await client.listFeatureOnlineStores(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listFeatureOnlineStores as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFeatureOnlineStores as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listFeatureOnlineStores without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listFeatureOnlineStores = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listFeatureOnlineStores(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IFeatureOnlineStore[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listFeatureOnlineStores with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listFeatureOnlineStores = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listFeatureOnlineStores(request), expectedError);
            const actualRequest = (client.innerApiCalls.listFeatureOnlineStores as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFeatureOnlineStores as SinonStub)
        ...
        it('invokes listFeatureOnlineStoresStream without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listFeatureOnlineStores.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listFeatureOnlineStoresStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.FeatureOnlineStore[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.FeatureOnlineStore) => {
            ...
            assert((client.descriptors.page.listFeatureOnlineStores.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listFeatureOnlineStores, request));
            assert(
                (client.descriptors.page.listFeatureOnlineStores.createStream as SinonStub)
        ...
        it('invokes listFeatureOnlineStoresStream with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFeatureOnlineStores.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listFeatureOnlineStoresStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.FeatureOnlineStore[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.FeatureOnlineStore) => {
        ...
        it('uses async iteration with listFeatureOnlineStores without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listFeatureOnlineStores.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1.IFeatureOnlineStore[] = [];
            const iterable = client.listFeatureOnlineStoresAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listFeatureOnlineStores.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listFeatureOnlineStores with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFeatureOnlineStores.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listFeatureOnlineStoresAsync(request);
    ...
    describe('listFeatureViews', () => {
        it('invokes listFeatureViews without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ListFeatureViewsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListFeatureViewsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.FeatureView()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.FeatureView()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.FeatureView()),
            ];
            client.innerApiCalls.listFeatureViews = stubSimpleCall(expectedResponse);
            const [response] = await client.listFeatureViews(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listFeatureViews as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFeatureViews as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listFeatureViews without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listFeatureViews = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listFeatureViews(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IFeatureView[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listFeatureViews with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listFeatureViews = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listFeatureViews(request), expectedError);
            const actualRequest = (client.innerApiCalls.listFeatureViews as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFeatureViews as SinonStub)
        ...
        it('invokes listFeatureViewsStream without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listFeatureViews.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listFeatureViewsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.FeatureView[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.FeatureView) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listFeatureViews.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listFeatureViews, request));
            assert(
        ...
        it('invokes listFeatureViewsStream with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFeatureViews.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listFeatureViewsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.FeatureView[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.FeatureView) => {
        ...
        it('uses async iteration with listFeatureViews without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listFeatureViews.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1.IFeatureView[] = [];
            const iterable = client.listFeatureViewsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
        ...
        it('uses async iteration with listFeatureViews with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFeatureViews.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listFeatureViewsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.aiplatform.v1.IFeatureView[] = [];
                for await (const resource of iterable) {
    ...
    describe('listFeatureViewSyncs', () => {
        it('invokes listFeatureViewSyncs without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ListFeatureViewSyncsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListFeatureViewSyncsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.FeatureViewSync()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.FeatureViewSync()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.FeatureViewSync()),
            ];
            client.innerApiCalls.listFeatureViewSyncs = stubSimpleCall(expectedResponse);
            const [response] = await client.listFeatureViewSyncs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listFeatureViewSyncs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFeatureViewSyncs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listFeatureViewSyncs without error using callback', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listFeatureViewSyncs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listFeatureViewSyncs(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IFeatureViewSync[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listFeatureViewSyncs with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listFeatureViewSyncs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listFeatureViewSyncs(request), expectedError);
            const actualRequest = (client.innerApiCalls.listFeatureViewSyncs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFeatureViewSyncs as SinonStub)
        ...
        it('invokes listFeatureViewSyncsStream without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listFeatureViewSyncs.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listFeatureViewSyncsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.FeatureViewSync[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.FeatureViewSync) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listFeatureViewSyncs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listFeatureViewSyncs, request));
            assert(
        ...
        it('invokes listFeatureViewSyncsStream with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFeatureViewSyncs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listFeatureViewSyncsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.FeatureViewSync[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.FeatureViewSync) => {
        ...
        it('uses async iteration with listFeatureViewSyncs without error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listFeatureViewSyncs.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1.IFeatureViewSync[] = [];
            const iterable = client.listFeatureViewSyncsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
        ...
        it('uses async iteration with listFeatureViewSyncs with error', async () => {
            const client = new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFeatureViewSyncs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listFeatureViewSyncsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.aiplatform.v1.IFeatureViewSync[] = [];
                for await (const resource of iterable) {
