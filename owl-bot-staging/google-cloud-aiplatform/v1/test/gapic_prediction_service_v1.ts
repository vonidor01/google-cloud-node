...
describe('v1.PredictionServiceClient', () => {
    ...
    describe('directPredict', () => {
        it('invokes directPredict without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DirectPredictRequest', ['endpoint']);
            request.endpoint = defaultValue1;
            const expectedHeaderRequestParams = `endpoint=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.directPredict as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.directPredict as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes directPredict without error using callback', async () => {
            ...
            client.innerApiCalls.directPredict = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.directPredict(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IDirectPredictResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('directRawPredict', () => {
        it('invokes directRawPredict without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DirectRawPredictRequest', ['endpoint']);
            request.endpoint = defaultValue1;
            const expectedHeaderRequestParams = `endpoint=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.directRawPredict as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.directRawPredict as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes directRawPredict without error using callback', async () => {
            ...
            client.innerApiCalls.directRawPredict = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.directRawPredict(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IDirectRawPredictResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateContent', () => {
        it('invokes generateContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GenerateContentRequest', ['model']);
        ...
        it('invokes generateContent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateContent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IGenerateContentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('streamRawPredict', () => {
        it('invokes streamRawPredict without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.StreamRawPredictRequest', ['endpoint']);
            request.endpoint = defaultValue1;
            const expectedHeaderRequestParams = `endpoint=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.api.HttpBody()
            );
            client.innerApiCalls.streamRawPredict = stubServerStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.streamRawPredict as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.streamRawPredict as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes streamRawPredict without error and gaxServerStreamingRetries enabled', async () => {
            const client = new predictionserviceModule.v1.PredictionServiceClient({gaxServerStreamingRetries: true});
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.StreamRawPredictRequest()
            );
        ...
        it('invokes streamRawPredict with closed client', async () => {
            ...
            const expectedError = new Error('The client has already been closed.');
            client.close();
            const stream = client.streamRawPredict(request, {retryRequestOptions: {noResponseRetries: 0}});
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.api.HttpBody) => {
                    resolve(response);
                });
    ...
    describe('serverStreamingPredict', () => {
        it('invokes serverStreamingPredict without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.StreamingPredictRequest', ['endpoint']);
            request.endpoint = defaultValue1;
            const expectedHeaderRequestParams = `endpoint=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.StreamingPredictResponse()
            );
            client.innerApiCalls.serverStreamingPredict = stubServerStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.serverStreamingPredict as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.serverStreamingPredict as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes serverStreamingPredict with closed client', async () => {
            ...
            const expectedError = new Error('The client has already been closed.');
            client.close();
            const stream = client.serverStreamingPredict(request, {retryRequestOptions: {noResponseRetries: 0}});
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.StreamingPredictResponse) => {
                    resolve(response);
                });
    ...
    describe('streamDirectPredict', () => {
        it('invokes streamDirectPredict without error', async () => {
            ...
            client.innerApiCalls.streamDirectPredict = stubBidiStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.streamDirectPredict as SinonStub)
        ...
        it('invokes streamDirectPredict with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.streamDirectPredict = stubBidiStreamingCall(undefined, expectedError);
            const stream = client.streamDirectPredict();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.StreamDirectPredictResponse) => {
                    resolve(response);
    ...
    describe('streamDirectRawPredict', () => {
        it('invokes streamDirectRawPredict without error', async () => {
            ...
            client.innerApiCalls.streamDirectRawPredict = stubBidiStreamingCall(expectedResponse);
            const stream = client.streamDirectRawPredict();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.StreamDirectRawPredictResponse) => {
                    resolve(response);
                });
                stream.on('error', (err: Error) => {
                    reject(err);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.streamDirectRawPredict as SinonStub)
                .getCall(0).calledWith(null));
            assert.deepStrictEqual(((stream as unknown as PassThrough)
                ._transform as SinonStub).getCall(0).args[0], request);
        });
        ...
        it('invokes streamDirectRawPredict with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.streamDirectRawPredict = stubBidiStreamingCall(undefined, expectedError);
            const stream = client.streamDirectRawPredict();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.StreamDirectRawPredictResponse) => {
                    resolve(response);
    ...
    describe('streamingPredict', () => {
        it('invokes streamingPredict without error', async () => {
            ...
            client.innerApiCalls.streamingPredict = stubBidiStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.streamingPredict as SinonStub)
                .getCall(0).calledWith(null));
            assert.deepStrictEqual(((stream as unknown as PassThrough)
                ._transform as SinonStub).getCall(0).args[0], request);
        });
        ...
        it('invokes streamingPredict with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.streamingPredict = stubBidiStreamingCall(undefined, expectedError);
            const stream = client.streamingPredict();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.StreamingPredictResponse) => {
                    resolve(response);
    ...
    describe('streamingRawPredict', () => {
        it('invokes streamingRawPredict without error', async () => {
            ...
            client.innerApiCalls.streamingRawPredict = stubBidiStreamingCall(expectedResponse);
            const stream = client.streamingRawPredict();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.StreamingRawPredictResponse) => {
                    resolve(response);
                });
                stream.on('error', (err: Error) => {
                    reject(err);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.streamingRawPredict as SinonStub)
                .getCall(0).calledWith(null));
            assert.deepStrictEqual(((stream as unknown as PassThrough)
                ._transform as SinonStub).getCall(0).args[0], request);
        });
        ...
        it('invokes streamingRawPredict with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.streamingRawPredict = stubBidiStreamingCall(undefined, expectedError);
            const stream = client.streamingRawPredict();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.StreamingRawPredictResponse) => {
                    resolve(response);
