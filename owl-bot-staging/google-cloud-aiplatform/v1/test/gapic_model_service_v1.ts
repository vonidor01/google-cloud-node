...
describe('v1.ModelServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new modelserviceModule.v1.ModelServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new modelserviceModule.v1.ModelServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new modelserviceModule.v1.ModelServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new modelserviceModule.v1.ModelServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
        ...
        it('invokes batchImportEvaluatedAnnotations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchImportEvaluatedAnnotations(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IBatchImportEvaluatedAnnotationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateExplanationDataset', () => {
        it('invokes updateExplanationDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UpdateExplanationDatasetRequest', ['model']);
        ...
        it('invokes updateExplanationDataset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateExplanationDataset(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IUpdateExplanationDatasetResponse, protos.google.cloud.aiplatform.v1.IUpdateExplanationDatasetOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IUpdateExplanationDatasetResponse, protos.google.cloud.aiplatform.v1.IUpdateExplanationDatasetOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateExplanationDataset as SinonStub)
                .getCall(0).args[0];
    ...
    describe('copyModel', () => {
        it('invokes copyModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CopyModelRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes copyModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.copyModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.ICopyModelResponse, protos.google.cloud.aiplatform.v1.ICopyModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.ICopyModelResponse, protos.google.cloud.aiplatform.v1.ICopyModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.copyModel as SinonStub)
                .getCall(0).args[0];
