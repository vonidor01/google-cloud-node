...
describe('v1.IndexServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = indexserviceModule.v1.IndexServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = indexserviceModule.v1.IndexServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new indexserviceModule.v1.IndexServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new indexserviceModule.v1.IndexServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new indexserviceModule.v1.IndexServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new indexserviceModule.v1.IndexServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = indexserviceModule.v1.IndexServiceClient.port;
            assert(port);
    ...
    describe('getIndex', () => {
        it('invokes getIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetIndexRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.Index()
            );
        ...
        it('invokes getIndex without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getIndex(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IIndex|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('upsertDatapoints', () => {
        it('invokes upsertDatapoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UpsertDatapointsRequest', ['index']);
        ...
        it('invokes upsertDatapoints without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.upsertDatapoints(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IUpsertDatapointsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('removeDatapoints', () => {
        it('invokes removeDatapoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.RemoveDatapointsRequest', ['index']);
            request.index = defaultValue1;
            const expectedHeaderRequestParams = `index=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes removeDatapoints without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.removeDatapoints(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IRemoveDatapointsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createIndex', () => {
        it('invokes createIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateIndexRequest', ['parent']);
        ...
        it('invokes createIndex without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createIndex(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IIndex, protos.google.cloud.aiplatform.v1.ICreateIndexOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IIndex, protos.google.cloud.aiplatform.v1.ICreateIndexOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createIndex as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateIndex', () => {
        it('invokes updateIndex without error', async () => {
            ...
            request.index ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UpdateIndexRequest', ['index', 'name']);
        ...
        it('invokes updateIndex without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateIndex(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IIndex, protos.google.cloud.aiplatform.v1.IUpdateIndexOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IIndex, protos.google.cloud.aiplatform.v1.IUpdateIndexOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateIndex as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteIndex', () => {
        it('invokes deleteIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteIndexRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listIndexes', () => {
        it('invokes listIndexes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListIndexesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.Index()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.Index()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.Index()),
            ];
        ...
        it('invokes listIndexesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.Index[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.Index) => {
        ...
        it('uses async iteration with listIndexes without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1.IIndex[] = [];
