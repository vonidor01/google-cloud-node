...
describe('v1.VertexRagDataServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = vertexragdataserviceModule.v1.VertexRagDataServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = vertexragdataserviceModule.v1.VertexRagDataServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new vertexragdataserviceModule.v1.VertexRagDataServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new vertexragdataserviceModule.v1.VertexRagDataServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new vertexragdataserviceModule.v1.VertexRagDataServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new vertexragdataserviceModule.v1.VertexRagDataServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = vertexragdataserviceModule.v1.VertexRagDataServiceClient.port;
            assert(port);
    ...
    describe('getRagCorpus', () => {
        it('invokes getRagCorpus without error', async () => {
            ...
            const actualRequest = (client.innerApiCalls.getRagCorpus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRagCorpus as SinonStub)
        ...
        it('invokes getRagCorpus without error using callback', async () => {
            ...
            client.innerApiCalls.getRagCorpus = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getRagCorpus(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IRagCorpus|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('uploadRagFile', () => {
        it('invokes uploadRagFile without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.uploadRagFile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.uploadRagFile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes uploadRagFile without error using callback', async () => {
            ...
            client.innerApiCalls.uploadRagFile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.uploadRagFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IUploadRagFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getRagFile', () => {
        it('invokes getRagFile without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getRagFile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRagFile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getRagFile without error using callback', async () => {
            ...
            client.innerApiCalls.getRagFile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getRagFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IRagFile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createRagCorpus', () => {
        it('invokes createRagCorpus without error', async () => {
            ...
            client.innerApiCalls.createRagCorpus = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createRagCorpus(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRagCorpus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createRagCorpus as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createRagCorpus without error using callback', async () => {
            ...
            client.innerApiCalls.createRagCorpus = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createRagCorpus(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IRagCorpus, protos.google.cloud.aiplatform.v1.ICreateRagCorpusOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IRagCorpus, protos.google.cloud.aiplatform.v1.ICreateRagCorpusOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRagCorpus as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateRagCorpusProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateRagCorpusProgress(expectedResponse.name);
        ...
        it('invokes checkCreateRagCorpusProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateRagCorpusProgress(''), expectedError);
    ...
    describe('updateRagCorpus', () => {
        it('invokes updateRagCorpus without error', async () => {
            ...
            client.innerApiCalls.updateRagCorpus = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateRagCorpus(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateRagCorpus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateRagCorpus as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateRagCorpus without error using callback', async () => {
            ...
            client.innerApiCalls.updateRagCorpus = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateRagCorpus(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IRagCorpus, protos.google.cloud.aiplatform.v1.IUpdateRagCorpusOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IRagCorpus, protos.google.cloud.aiplatform.v1.IUpdateRagCorpusOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateRagCorpus as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateRagCorpusProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateRagCorpusProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateRagCorpusProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateRagCorpusProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteRagCorpus', () => {
        it('invokes deleteRagCorpus without error', async () => {
            ...
            client.innerApiCalls.deleteRagCorpus = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteRagCorpus(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteRagCorpus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteRagCorpus as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteRagCorpus without error using callback', async () => {
            ...
            client.innerApiCalls.deleteRagCorpus = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes checkDeleteRagCorpusProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteRagCorpusProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteRagCorpusProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteRagCorpusProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('importRagFiles', () => {
        it('invokes importRagFiles without error', async () => {
            ...
            client.innerApiCalls.importRagFiles = stubLongRunningCall(expectedResponse);
            const [operation] = await client.importRagFiles(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importRagFiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importRagFiles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes importRagFiles without error using callback', async () => {
            ...
            client.innerApiCalls.importRagFiles = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.importRagFiles(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IImportRagFilesResponse, protos.google.cloud.aiplatform.v1.IImportRagFilesOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IImportRagFilesResponse, protos.google.cloud.aiplatform.v1.IImportRagFilesOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importRagFiles as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkImportRagFilesProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkImportRagFilesProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkImportRagFilesProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkImportRagFilesProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteRagFile', () => {
        it('invokes deleteRagFile without error', async () => {
            ...
            client.innerApiCalls.deleteRagFile = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteRagFile(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteRagFile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteRagFile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteRagFile without error using callback', async () => {
            ...
            client.innerApiCalls.deleteRagFile = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes checkDeleteRagFileProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteRagFileProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('listRagCorpora', () => {
        it('invokes listRagCorpora without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listRagCorpora as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRagCorpora as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listRagCorpora without error using callback', async () => {
            ...
            client.innerApiCalls.listRagCorpora = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listRagCorporaStream without error', async () => {
            ...
            client.descriptors.page.listRagCorpora.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listRagCorporaStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.RagCorpus[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.RagCorpus) => {
            ...
            assert((client.descriptors.page.listRagCorpora.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listRagCorpora, request));
            assert(
        ...
        it('uses async iteration with listRagCorpora without error', async () => {
            ...
            client.descriptors.page.listRagCorpora.asyncIterate = stubAsyncIterationCall(expectedResponse);
    ...
    describe('listRagFiles', () => {
        it('invokes listRagFiles without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listRagFiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRagFiles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listRagFiles without error using callback', async () => {
            ...
            client.innerApiCalls.listRagFiles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listRagFiles(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IRagFile[]|null) => {
        ...
        it('invokes listRagFilesStream without error', async () => {
            ...
            client.descriptors.page.listRagFiles.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listRagFilesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.RagFile[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.RagFile) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listRagFiles.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listRagFiles, request));
            assert(
        ...
        it('uses async iteration with listRagFiles without error', async () => {
            ...
            client.descriptors.page.listRagFiles.asyncIterate = stubAsyncIterationCall(expectedResponse);
