...
describe('v1.EndpointServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = endpointserviceModule.v1.EndpointServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = endpointserviceModule.v1.EndpointServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new endpointserviceModule.v1.EndpointServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new endpointserviceModule.v1.EndpointServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new endpointserviceModule.v1.EndpointServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new endpointserviceModule.v1.EndpointServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getEndpoint', () => {
        ...
        it('invokes getEndpoint without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEndpoint(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IEndpoint|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createEndpoint', () => {
        it('invokes createEndpoint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateEndpointRequest', ['parent']);
        ...
        it('invokes createEndpoint without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createEndpoint(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IEndpoint, protos.google.cloud.aiplatform.v1.ICreateEndpointOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IEndpoint, protos.google.cloud.aiplatform.v1.ICreateEndpointOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createEndpoint as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateEndpointLongRunning', () => {
        it('invokes updateEndpointLongRunning without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.UpdateEndpointLongRunningRequest()
            );
            request.endpoint ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UpdateEndpointLongRunningRequest', ['endpoint', 'name']);
            request.endpoint.name = defaultValue1;
            const expectedHeaderRequestParams = `endpoint.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateEndpointLongRunning = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateEndpointLongRunning(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateEndpointLongRunning as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateEndpointLongRunning as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateEndpointLongRunning without error using callback', async () => {
            ...
            client.innerApiCalls.updateEndpointLongRunning = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateEndpointLongRunning(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IEndpoint, protos.google.cloud.aiplatform.v1.IUpdateEndpointOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IEndpoint, protos.google.cloud.aiplatform.v1.IUpdateEndpointOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateEndpointLongRunning as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateEndpointLongRunningProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateEndpointLongRunningProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateEndpointLongRunningProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateEndpointLongRunningProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteEndpoint', () => {
        it('invokes deleteEndpoint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteEndpointRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deployModel', () => {
        it('invokes deployModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeployModelRequest', ['endpoint']);
        ...
        it('invokes deployModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deployModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IDeployModelResponse, protos.google.cloud.aiplatform.v1.IDeployModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IDeployModelResponse, protos.google.cloud.aiplatform.v1.IDeployModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deployModel as SinonStub)
                .getCall(0).args[0];
    ...
    describe('undeployModel', () => {
        it('invokes undeployModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UndeployModelRequest', ['endpoint']);
            request.endpoint = defaultValue1;
            const expectedHeaderRequestParams = `endpoint=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes undeployModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.undeployModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IUndeployModelResponse, protos.google.cloud.aiplatform.v1.IUndeployModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IUndeployModelResponse, protos.google.cloud.aiplatform.v1.IUndeployModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeployModel as SinonStub)
                .getCall(0).args[0];
    ...
    describe('mutateDeployedModel', () => {
        it('invokes mutateDeployedModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.MutateDeployedModelRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.MutateDeployedModelRequest', ['endpoint']);
            request.endpoint = defaultValue1;
            const expectedHeaderRequestParams = `endpoint=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.mutateDeployedModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.mutateDeployedModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.mutateDeployedModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateDeployedModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes mutateDeployedModel without error using callback', async () => {
            ...
            client.innerApiCalls.mutateDeployedModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateDeployedModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IMutateDeployedModelResponse, protos.google.cloud.aiplatform.v1.IMutateDeployedModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IMutateDeployedModelResponse, protos.google.cloud.aiplatform.v1.IMutateDeployedModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.mutateDeployedModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkMutateDeployedModelProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkMutateDeployedModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkMutateDeployedModelProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkMutateDeployedModelProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listEndpoints', () => {
        it('invokes listEndpoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListEndpointsRequest', ['parent']);
            request.parent = defaultValue1;
