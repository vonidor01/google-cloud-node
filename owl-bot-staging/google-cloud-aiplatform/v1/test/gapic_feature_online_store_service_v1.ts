...
describe('v1.FeatureOnlineStoreServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = featureonlinestoreserviceModule.v1.FeatureOnlineStoreServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = featureonlinestoreserviceModule.v1.FeatureOnlineStoreServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new featureonlinestoreserviceModule.v1.FeatureOnlineStoreServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new featureonlinestoreserviceModule.v1.FeatureOnlineStoreServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new featureonlinestoreserviceModule.v1.FeatureOnlineStoreServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new featureonlinestoreserviceModule.v1.FeatureOnlineStoreServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = featureonlinestoreserviceModule.v1.FeatureOnlineStoreServiceClient.port;
            assert(port);
    ...
    describe('fetchFeatureValues', () => {
        it('invokes fetchFeatureValues without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.FetchFeatureValuesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.FetchFeatureValuesRequest', ['featureView']);
            request.featureView = defaultValue1;
            const expectedHeaderRequestParams = `feature_view=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.FetchFeatureValuesResponse()
            );
        ...
        it('invokes fetchFeatureValues without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchFeatureValues(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IFetchFeatureValuesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('searchNearestEntities', () => {
        it('invokes searchNearestEntities without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.SearchNearestEntitiesRequest', ['featureView']);
            request.featureView = defaultValue1;
            const expectedHeaderRequestParams = `feature_view=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes searchNearestEntities without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.searchNearestEntities(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ISearchNearestEntitiesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
