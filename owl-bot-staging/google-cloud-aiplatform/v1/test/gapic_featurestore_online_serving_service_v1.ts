...
describe('v1.FeaturestoreOnlineServingServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = featurestoreonlineservingserviceModule.v1.FeaturestoreOnlineServingServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = featurestoreonlineservingserviceModule.v1.FeaturestoreOnlineServingServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new featurestoreonlineservingserviceModule.v1.FeaturestoreOnlineServingServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new featurestoreonlineservingserviceModule.v1.FeaturestoreOnlineServingServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new featurestoreonlineservingserviceModule.v1.FeaturestoreOnlineServingServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new featurestoreonlineservingserviceModule.v1.FeaturestoreOnlineServingServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = featurestoreonlineservingserviceModule.v1.FeaturestoreOnlineServingServiceClient.port;
            assert(port);
    ...
    describe('readFeatureValues', () => {
        it('invokes readFeatureValues without error', async () => {
            ...
            const actualRequest = (client.innerApiCalls.readFeatureValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.readFeatureValues as SinonStub)
        ...
        it('invokes readFeatureValues without error using callback', async () => {
            ...
            client.innerApiCalls.readFeatureValues = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.readFeatureValues(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IReadFeatureValuesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('writeFeatureValues', () => {
        it('invokes writeFeatureValues without error', async () => {
            ...
            client.innerApiCalls.writeFeatureValues = stubSimpleCall(expectedResponse);
            const [response] = await client.writeFeatureValues(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.writeFeatureValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.writeFeatureValues as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes writeFeatureValues without error using callback', async () => {
            ...
            client.innerApiCalls.writeFeatureValues = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.writeFeatureValues(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IWriteFeatureValuesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
