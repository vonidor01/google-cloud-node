    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = evaluationserviceModule.v1.EvaluationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new evaluationserviceModule.v1.EvaluationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new evaluationserviceModule.v1.EvaluationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new evaluationserviceModule.v1.EvaluationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new evaluationserviceModule.v1.EvaluationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = evaluationserviceModule.v1.EvaluationServiceClient.port;
            assert(port);
    ...
    describe('evaluateInstances', () => {
        it('invokes evaluateInstances without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.EvaluateInstancesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.EvaluateInstancesRequest', ['location']);
            request.location = defaultValue1;
            const expectedHeaderRequestParams = `location=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.EvaluateInstancesResponse()
            );
            ...
            const actualRequest = (client.innerApiCalls.evaluateInstances as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.evaluateInstances as SinonStub)
        ...
        it('invokes evaluateInstances without error using callback', async () => {
            ...
            client.innerApiCalls.evaluateInstances = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.evaluateInstances(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IEvaluateInstancesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
