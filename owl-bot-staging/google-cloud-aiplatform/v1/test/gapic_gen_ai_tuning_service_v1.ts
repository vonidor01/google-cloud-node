...
describe('v1.GenAiTuningServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = genaituningserviceModule.v1.GenAiTuningServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = genaituningserviceModule.v1.GenAiTuningServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new genaituningserviceModule.v1.GenAiTuningServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new genaituningserviceModule.v1.GenAiTuningServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new genaituningserviceModule.v1.GenAiTuningServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new genaituningserviceModule.v1.GenAiTuningServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = genaituningserviceModule.v1.GenAiTuningServiceClient.port;
            assert(port);
    ...
    describe('createTuningJob', () => {
        it('invokes createTuningJob without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CreateTuningJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateTuningJobRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.TuningJob()
            );
            client.innerApiCalls.createTuningJob = stubSimpleCall(expectedResponse);
            const [response] = await client.createTuningJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createTuningJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createTuningJob as SinonStub)
        ...
        it('invokes createTuningJob without error using callback', async () => {
            ...
            client.innerApiCalls.createTuningJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createTuningJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ITuningJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createTuningJob with error', async () => {
            ...
            client.innerApiCalls.createTuningJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('getTuningJob', () => {
        it('invokes getTuningJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.GetTuningJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetTuningJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.TuningJob()
            );
            client.innerApiCalls.getTuningJob = stubSimpleCall(expectedResponse);
            const [response] = await client.getTuningJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getTuningJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getTuningJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getTuningJob without error using callback', async () => {
            ...
            client.innerApiCalls.getTuningJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getTuningJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ITuningJob|null) => {
        ...
        it('invokes getTuningJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getTuningJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('cancelTuningJob', () => {
        it('invokes cancelTuningJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CancelTuningJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CancelTuningJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.cancelTuningJob = stubSimpleCall(expectedResponse);
            const [response] = await client.cancelTuningJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelTuningJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelTuningJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes cancelTuningJob without error using callback', async () => {
            ...
            client.innerApiCalls.cancelTuningJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.cancelTuningJob(
                    request,
        ...
        it('invokes cancelTuningJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelTuningJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('rebaseTunedModel', () => {
        it('invokes rebaseTunedModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.RebaseTunedModelRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.RebaseTunedModelRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.rebaseTunedModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.rebaseTunedModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rebaseTunedModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.rebaseTunedModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes rebaseTunedModel without error using callback', async () => {
            ...
            client.innerApiCalls.rebaseTunedModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.rebaseTunedModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.ITuningJob, protos.google.cloud.aiplatform.v1.IRebaseTunedModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.ITuningJob, protos.google.cloud.aiplatform.v1.IRebaseTunedModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rebaseTunedModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes rebaseTunedModel with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.rebaseTunedModel = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.rebaseTunedModel(request), expectedError);
            const actualRequest = (client.innerApiCalls.rebaseTunedModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.rebaseTunedModel as SinonStub)
        ...
        it('invokes rebaseTunedModel with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.rebaseTunedModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.rebaseTunedModel(request);
        ...
        it('invokes checkRebaseTunedModelProgress without error', async () => {
            ...
            const decodedOperation = await client.checkRebaseTunedModelProgress(expectedResponse.name);
        ...
        it('invokes checkRebaseTunedModelProgress with error', async () => {
            ...
            await assert.rejects(client.checkRebaseTunedModelProgress(''), expectedError);
    ...
    describe('listTuningJobs', () => {
        it('invokes listTuningJobs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ListTuningJobsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListTuningJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.TuningJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.TuningJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.TuningJob()),
            ];
            client.innerApiCalls.listTuningJobs = stubSimpleCall(expectedResponse);
            const [response] = await client.listTuningJobs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listTuningJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTuningJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listTuningJobs without error using callback', async () => {
            ...
            client.innerApiCalls.listTuningJobs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listTuningJobs(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ITuningJob[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listTuningJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listTuningJobs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listTuningJobs(request), expectedError);
            const actualRequest = (client.innerApiCalls.listTuningJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTuningJobs as SinonStub)
        ...
        it('invokes listTuningJobsStream without error', async () => {
            ...
            client.descriptors.page.listTuningJobs.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listTuningJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.TuningJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.TuningJob) => {
            ...
            assert((client.descriptors.page.listTuningJobs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listTuningJobs, request));
            assert(
        ...
        it('invokes listTuningJobsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTuningJobs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listTuningJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.TuningJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.TuningJob) => {
        ...
        it('uses async iteration with listTuningJobs without error', async () => {
            ...
            client.descriptors.page.listTuningJobs.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1.ITuningJob[] = [];
            const iterable = client.listTuningJobsAsync(request);
        ...
        it('uses async iteration with listTuningJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTuningJobs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listTuningJobsAsync(request);
