...
describe('v1.PipelineServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = pipelineserviceModule.v1.PipelineServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = pipelineserviceModule.v1.PipelineServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new pipelineserviceModule.v1.PipelineServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new pipelineserviceModule.v1.PipelineServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createTrainingPipeline', () => {
        it('invokes createTrainingPipeline without error', async () => {
            ...
            client.innerApiCalls.createTrainingPipeline = stubSimpleCall(expectedResponse);
            const [response] = await client.createTrainingPipeline(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createTrainingPipeline as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createTrainingPipeline as SinonStub)
        ...
        it('invokes createTrainingPipeline without error using callback', async () => {
            ...
            client.innerApiCalls.createTrainingPipeline = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createTrainingPipeline(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ITrainingPipeline|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createTrainingPipeline with error', async () => {
            ...
            client.innerApiCalls.createTrainingPipeline = stubSimpleCall(undefined, expectedError);
    ...
    describe('getTrainingPipeline', () => {
        it('invokes getTrainingPipeline without error', async () => {
            ...
            client.innerApiCalls.getTrainingPipeline = stubSimpleCall(expectedResponse);
            const [response] = await client.getTrainingPipeline(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getTrainingPipeline as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getTrainingPipeline as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getTrainingPipeline without error using callback', async () => {
            ...
            client.innerApiCalls.getTrainingPipeline = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getTrainingPipeline with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getTrainingPipeline = stubSimpleCall(undefined, expectedError);
    ...
    describe('cancelTrainingPipeline', () => {
        it('invokes cancelTrainingPipeline without error', async () => {
            ...
            client.innerApiCalls.cancelTrainingPipeline = stubSimpleCall(expectedResponse);
            const [response] = await client.cancelTrainingPipeline(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelTrainingPipeline as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelTrainingPipeline as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes cancelTrainingPipeline without error using callback', async () => {
            ...
            client.innerApiCalls.cancelTrainingPipeline = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes cancelTrainingPipeline with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelTrainingPipeline = stubSimpleCall(undefined, expectedError);
    ...
    describe('createPipelineJob', () => {
        it('invokes createPipelineJob without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPipelineJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createPipelineJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createPipelineJob without error using callback', async () => {
            ...
            client.innerApiCalls.createPipelineJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createPipelineJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IPipelineJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createPipelineJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createPipelineJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('getPipelineJob', () => {
        it('invokes getPipelineJob without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPipelineJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPipelineJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getPipelineJob without error using callback', async () => {
            ...
            client.innerApiCalls.getPipelineJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getPipelineJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getPipelineJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('cancelPipelineJob', () => {
        it('invokes cancelPipelineJob without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelPipelineJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelPipelineJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes cancelPipelineJob without error using callback', async () => {
            ...
            client.innerApiCalls.cancelPipelineJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes cancelPipelineJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelPipelineJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteTrainingPipeline', () => {
        it('invokes deleteTrainingPipeline without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteTrainingPipelineRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteTrainingPipeline = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteTrainingPipeline(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteTrainingPipeline as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteTrainingPipeline as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteTrainingPipeline without error using callback', async () => {
            ...
            client.innerApiCalls.deleteTrainingPipeline = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteTrainingPipeline with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteTrainingPipeline = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteTrainingPipeline(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteTrainingPipeline as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteTrainingPipeline as SinonStub)
        ...
        it('invokes deleteTrainingPipeline with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteTrainingPipeline = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteTrainingPipeline(request);
        ...
        it('invokes checkDeleteTrainingPipelineProgress without error', async () => {
            ...
            const decodedOperation = await client.checkDeleteTrainingPipelineProgress(expectedResponse.name);
        ...
        it('invokes checkDeleteTrainingPipelineProgress with error', async () => {
            ...
            await assert.rejects(client.checkDeleteTrainingPipelineProgress(''), expectedError);
    ...
    describe('deletePipelineJob', () => {
        it('invokes deletePipelineJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeletePipelineJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deletePipelineJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deletePipelineJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deletePipelineJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deletePipelineJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deletePipelineJob without error using callback', async () => {
            ...
            client.innerApiCalls.deletePipelineJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deletePipelineJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deletePipelineJob = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deletePipelineJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deletePipelineJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deletePipelineJob(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deletePipelineJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeletePipelineJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeletePipelineJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeletePipelineJobProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeletePipelineJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('batchDeletePipelineJobs', () => {
        it('invokes batchDeletePipelineJobs without error', async () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.BatchDeletePipelineJobsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.BatchDeletePipelineJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.batchDeletePipelineJobs = stubLongRunningCall(expectedResponse);
            const [operation] = await client.batchDeletePipelineJobs(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchDeletePipelineJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeletePipelineJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchDeletePipelineJobs without error using callback', async () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchDeletePipelineJobs = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchDeletePipelineJobs(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IBatchDeletePipelineJobsResponse, protos.google.cloud.aiplatform.v1.IDeleteOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IBatchDeletePipelineJobsResponse, protos.google.cloud.aiplatform.v1.IDeleteOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchDeletePipelineJobs as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes batchDeletePipelineJobs with call error', async () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchDeletePipelineJobs = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.batchDeletePipelineJobs(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchDeletePipelineJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeletePipelineJobs as SinonStub)
        ...
        it('invokes batchDeletePipelineJobs with LRO error', async () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchDeletePipelineJobs = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.batchDeletePipelineJobs(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.batchDeletePipelineJobs as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkBatchDeletePipelineJobsProgress without error', async () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkBatchDeletePipelineJobsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkBatchDeletePipelineJobsProgress with error', async () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkBatchDeletePipelineJobsProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('batchCancelPipelineJobs', () => {
        it('invokes batchCancelPipelineJobs without error', async () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.BatchCancelPipelineJobsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.BatchCancelPipelineJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.batchCancelPipelineJobs = stubLongRunningCall(expectedResponse);
            const [operation] = await client.batchCancelPipelineJobs(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCancelPipelineJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCancelPipelineJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchCancelPipelineJobs without error using callback', async () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchCancelPipelineJobs = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchCancelPipelineJobs(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IBatchCancelPipelineJobsResponse, protos.google.cloud.aiplatform.v1.IBatchCancelPipelineJobsOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IBatchCancelPipelineJobsResponse, protos.google.cloud.aiplatform.v1.IBatchCancelPipelineJobsOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCancelPipelineJobs as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes batchCancelPipelineJobs with call error', async () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchCancelPipelineJobs = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.batchCancelPipelineJobs(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchCancelPipelineJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCancelPipelineJobs as SinonStub)
        ...
        it('invokes batchCancelPipelineJobs with LRO error', async () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchCancelPipelineJobs = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.batchCancelPipelineJobs(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.batchCancelPipelineJobs as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkBatchCancelPipelineJobsProgress without error', async () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkBatchCancelPipelineJobsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkBatchCancelPipelineJobsProgress with error', async () => {
            const client = new pipelineserviceModule.v1.PipelineServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkBatchCancelPipelineJobsProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listTrainingPipelines', () => {
        it('invokes listTrainingPipelines without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListTrainingPipelinesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.TrainingPipeline()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.TrainingPipeline()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.TrainingPipeline()),
            ];
            client.innerApiCalls.listTrainingPipelines = stubSimpleCall(expectedResponse);
            const [response] = await client.listTrainingPipelines(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listTrainingPipelines as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTrainingPipelines as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listTrainingPipelines without error using callback', async () => {
            ...
            client.innerApiCalls.listTrainingPipelines = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listTrainingPipelines with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listTrainingPipelines = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listTrainingPipelines(request), expectedError);
            const actualRequest = (client.innerApiCalls.listTrainingPipelines as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTrainingPipelines as SinonStub)
        ...
        it('invokes listTrainingPipelinesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.TrainingPipeline) => {
            ...
            assert((client.descriptors.page.listTrainingPipelines.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listTrainingPipelines, request));
            assert(
                (client.descriptors.page.listTrainingPipelines.createStream as SinonStub)
        ...
        it('invokes listTrainingPipelinesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTrainingPipelines.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listTrainingPipelinesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.TrainingPipeline[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.TrainingPipeline) => {
        ...
        it('uses async iteration with listTrainingPipelines without error', async () => {
            ...
            client.descriptors.page.listTrainingPipelines.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listTrainingPipelines.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listTrainingPipelines with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTrainingPipelines.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listTrainingPipelinesAsync(request);
    ...
    describe('listPipelineJobs', () => {
        it('invokes listPipelineJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListPipelineJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPipelineJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPipelineJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listPipelineJobs without error using callback', async () => {
            ...
            client.innerApiCalls.listPipelineJobs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listPipelineJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listPipelineJobs = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listPipelineJobsStream without error', async () => {
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listPipelineJobs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPipelineJobs, request));
            assert(
        ...
        it('invokes listPipelineJobsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPipelineJobs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listPipelineJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.PipelineJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.PipelineJob) => {
        ...
        it('uses async iteration with listPipelineJobs without error', async () => {
            ...
            client.descriptors.page.listPipelineJobs.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listPipelineJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPipelineJobs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listPipelineJobsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.aiplatform.v1.IPipelineJob[] = [];
                for await (const resource of iterable) {
