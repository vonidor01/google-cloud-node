 ...
 * @memberof v1
 */
export class FeaturestoreOnlineServingServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.FeaturestoreOnlineServingService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.featurestoreOnlineServingServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.FeaturestoreOnlineServingService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1.FeaturestoreOnlineServingService,
 ...
 */
  readFeatureValues(
      request?: protos.google.cloud.aiplatform.v1.IReadFeatureValuesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IReadFeatureValuesResponse,
        protos.google.cloud.aiplatform.v1.IReadFeatureValuesRequest|undefined, {}|undefined
      ]>;
  readFeatureValues(
      request: protos.google.cloud.aiplatform.v1.IReadFeatureValuesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IReadFeatureValuesResponse,
          protos.google.cloud.aiplatform.v1.IReadFeatureValuesRequest|null|undefined,
          {}|null|undefined>): void;
  readFeatureValues(
      request: protos.google.cloud.aiplatform.v1.IReadFeatureValuesRequest,
      callback: Callback<
 ...
 */
  writeFeatureValues(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1.IWriteFeatureValuesRequest|undefined, {}|undefined
      ]>;
  writeFeatureValues(
      request: protos.google.cloud.aiplatform.v1.IWriteFeatureValuesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IWriteFeatureValuesResponse,
          protos.google.cloud.aiplatform.v1.IWriteFeatureValuesRequest|null|undefined,
          {}|null|undefined>): void;
  writeFeatureValues(
      request: protos.google.cloud.aiplatform.v1.IWriteFeatureValuesRequest,
      callback: Callback<
 ...
 */
  streamingReadFeatureValues(
      request?: protos.google.cloud.aiplatform.v1.IStreamingReadFeatureValuesRequest,
      options?: CallOptions):
