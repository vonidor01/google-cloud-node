...
export class DeploymentResourcePoolServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createDeploymentResourcePoolResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.DeploymentResourcePool') as gax.protobuf.Type;
    const createDeploymentResourcePoolMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.CreateDeploymentResourcePoolOperationMetadata') as gax.protobuf.Type;
    ...
    const updateDeploymentResourcePoolMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.UpdateDeploymentResourcePoolOperationMetadata') as gax.protobuf.Type;
    ...
    this.descriptors.longrunning = {
      ...
      updateDeploymentResourcePool: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateDeploymentResourcePoolResponse.decode.bind(updateDeploymentResourcePoolResponse),
        updateDeploymentResourcePoolMetadata.decode.bind(updateDeploymentResourcePoolMetadata)),
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.DeploymentResourcePoolService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.deploymentResourcePoolServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.DeploymentResourcePoolService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1.DeploymentResourcePoolService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const deploymentResourcePoolServiceStubMethods =
        ['createDeploymentResourcePool', 'getDeploymentResourcePool', 'listDeploymentResourcePools', 'updateDeploymentResourcePool', 'deleteDeploymentResourcePool', 'queryDeployedModels'];
 ...
 */
  getDeploymentResourcePool(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1.IGetDeploymentResourcePoolRequest|undefined, {}|undefined
      ]>;
  getDeploymentResourcePool(
      request: protos.google.cloud.aiplatform.v1.IGetDeploymentResourcePoolRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IDeploymentResourcePool,
          protos.google.cloud.aiplatform.v1.IGetDeploymentResourcePoolRequest|null|undefined,
          {}|null|undefined>): void;
  getDeploymentResourcePool(
      request: protos.google.cloud.aiplatform.v1.IGetDeploymentResourcePoolRequest,
      callback: Callback<
 ...
 * region_tag:aiplatform_v1_generated_DeploymentResourcePoolService_CreateDeploymentResourcePool_async
 */
  async checkCreateDeploymentResourcePoolProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.DeploymentResourcePool, protos.google.cloud.aiplatform.v1.CreateDeploymentResourcePoolOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.DeploymentResourcePool, protos.google.cloud.aiplatform.v1.CreateDeploymentResourcePoolOperationMetadata>;
  }
/**
 ...
 */
  updateDeploymentResourcePool(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1.IDeploymentResourcePool, protos.google.cloud.aiplatform.v1.IUpdateDeploymentResourcePoolOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  updateDeploymentResourcePool(
      request: protos.google.cloud.aiplatform.v1.IUpdateDeploymentResourcePoolRequest,
  ...
  updateDeploymentResourcePool(
    ...
    options.otherArgs.headers[
      ...
      'deployment_resource_pool.name': request.deploymentResourcePool!.name ?? '',
    });
    this.initialize();
 ...
 */
  async checkUpdateDeploymentResourcePoolProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.DeploymentResourcePool, protos.google.cloud.aiplatform.v1.UpdateDeploymentResourcePoolOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.DeploymentResourcePool, protos.google.cloud.aiplatform.v1.UpdateDeploymentResourcePoolOperationMetadata>;
  }
/**
 ...
 * region_tag:aiplatform_v1_generated_DeploymentResourcePoolService_DeleteDeploymentResourcePool_async
 */
  async checkDeleteDeploymentResourcePoolProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1.DeleteOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
 ...
 */
  ...
  listDeploymentResourcePools(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.aiplatform.v1.IListDeploymentResourcePoolsResponse|null|undefined,
          protos.google.cloud.aiplatform.v1.IDeploymentResourcePool>): void;
  listDeploymentResourcePools(
      request: protos.google.cloud.aiplatform.v1.IListDeploymentResourcePoolsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1.IListDeploymentResourcePoolsRequest,
 ...
 */
  ...
  queryDeployedModels(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.aiplatform.v1.IQueryDeployedModelsResponse|null|undefined,
          protos.google.cloud.aiplatform.v1.IDeployedModel>): void;
  queryDeployedModels(
      request: protos.google.cloud.aiplatform.v1.IQueryDeployedModelsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1.IQueryDeployedModelsRequest,
