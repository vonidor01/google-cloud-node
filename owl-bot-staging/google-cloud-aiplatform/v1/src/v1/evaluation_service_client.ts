 ...
 * `src/v1/evaluation_service_client_config.json`.
...
export class EvaluationServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.EvaluationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.evaluationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.EvaluationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1.EvaluationService,
 ...
 * @param {google.cloud.aiplatform.v1.ExactMatchInput} request.exactMatchInput
 *   Auto metric instances.
 *   Instances and metric spec for exact match metric.
 * @param {google.cloud.aiplatform.v1.BleuInput} request.bleuInput
 *   Instances and metric spec for bleu metric.
 * @param {google.cloud.aiplatform.v1.RougeInput} request.rougeInput
 *   Instances and metric spec for rouge metric.
 * @param {google.cloud.aiplatform.v1.FluencyInput} request.fluencyInput
 *   LLM-based metric instance.
 *   General text generation metrics, applicable to other categories.
 *   Input for fluency metric.
 * @param {google.cloud.aiplatform.v1.CoherenceInput} request.coherenceInput
 *   Input for coherence metric.
 * @param {google.cloud.aiplatform.v1.SafetyInput} request.safetyInput
 *   Input for safety metric.
 * @param {google.cloud.aiplatform.v1.GroundednessInput} request.groundednessInput
 *   Input for groundedness metric.
 * @param {google.cloud.aiplatform.v1.FulfillmentInput} request.fulfillmentInput
 *   Input for fulfillment metric.
 * @param {google.cloud.aiplatform.v1.SummarizationQualityInput} request.summarizationQualityInput
 *   Input for summarization quality metric.
 * @param {google.cloud.aiplatform.v1.PairwiseSummarizationQualityInput} request.pairwiseSummarizationQualityInput
 *   Input for pairwise summarization quality metric.
 * @param {google.cloud.aiplatform.v1.SummarizationHelpfulnessInput} request.summarizationHelpfulnessInput
 *   Input for summarization helpfulness metric.
 * @param {google.cloud.aiplatform.v1.SummarizationVerbosityInput} request.summarizationVerbosityInput
 *   Input for summarization verbosity metric.
 * @param {google.cloud.aiplatform.v1.QuestionAnsweringQualityInput} request.questionAnsweringQualityInput
 *   Input for question answering quality metric.
 * @param {google.cloud.aiplatform.v1.PairwiseQuestionAnsweringQualityInput} request.pairwiseQuestionAnsweringQualityInput
 *   Input for pairwise question answering quality metric.
 * @param {google.cloud.aiplatform.v1.QuestionAnsweringRelevanceInput} request.questionAnsweringRelevanceInput
 *   Input for question answering relevance metric.
 * @param {google.cloud.aiplatform.v1.QuestionAnsweringHelpfulnessInput} request.questionAnsweringHelpfulnessInput
 *   Input for question answering helpfulness
 *   metric.
 * @param {google.cloud.aiplatform.v1.QuestionAnsweringCorrectnessInput} request.questionAnsweringCorrectnessInput
 *   Input for question answering correctness
 *   metric.
 * @param {google.cloud.aiplatform.v1.PointwiseMetricInput} request.pointwiseMetricInput
 *   Input for pointwise metric.
 * @param {google.cloud.aiplatform.v1.PairwiseMetricInput} request.pairwiseMetricInput
 *   Input for pairwise metric.
 * @param {google.cloud.aiplatform.v1.ToolCallValidInput} request.toolCallValidInput
 *   Tool call metric instances.
 *   Input for tool call valid metric.
 * @param {google.cloud.aiplatform.v1.ToolNameMatchInput} request.toolNameMatchInput
 *   Input for tool name match metric.
 * @param {google.cloud.aiplatform.v1.ToolParameterKeyMatchInput} request.toolParameterKeyMatchInput
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1.EvaluateInstancesResponse|EvaluateInstancesResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/evaluation_service.evaluate_instances.js</caption>
 * region_tag:aiplatform_v1_generated_EvaluationService_EvaluateInstances_async
 */
  evaluateInstances(
      request?: protos.google.cloud.aiplatform.v1.IEvaluateInstancesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IEvaluateInstancesResponse,
        protos.google.cloud.aiplatform.v1.IEvaluateInstancesRequest|undefined, {}|undefined
      ]>;
  evaluateInstances(
      request: protos.google.cloud.aiplatform.v1.IEvaluateInstancesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IEvaluateInstancesResponse,
          protos.google.cloud.aiplatform.v1.IEvaluateInstancesRequest|null|undefined,
          {}|null|undefined>): void;
  evaluateInstances(
      request: protos.google.cloud.aiplatform.v1.IEvaluateInstancesRequest,
      callback: Callback<
