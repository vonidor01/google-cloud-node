 ...
 * `src/v1/vertex_rag_data_service_client_config.json`.
...
export class VertexRagDataServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createRagCorpusResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.RagCorpus') as gax.protobuf.Type;
    const createRagCorpusMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.CreateRagCorpusOperationMetadata') as gax.protobuf.Type;
    const updateRagCorpusResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.RagCorpus') as gax.protobuf.Type;
    const updateRagCorpusMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.UpdateRagCorpusOperationMetadata') as gax.protobuf.Type;
    ...
    const importRagFilesResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.ImportRagFilesResponse') as gax.protobuf.Type;
    const importRagFilesMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.ImportRagFilesOperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.VertexRagDataService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.vertexRagDataServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.VertexRagDataService') :
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1.RagCorpus|RagCorpus}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/vertex_rag_data_service.get_rag_corpus.js</caption>
 * region_tag:aiplatform_v1_generated_VertexRagDataService_GetRagCorpus_async
 */
  getRagCorpus(
      request?: protos.google.cloud.aiplatform.v1.IGetRagCorpusRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IRagCorpus,
        protos.google.cloud.aiplatform.v1.IGetRagCorpusRequest|undefined, {}|undefined
      ]>;
  getRagCorpus(
      request: protos.google.cloud.aiplatform.v1.IGetRagCorpusRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IRagCorpus,
          protos.google.cloud.aiplatform.v1.IGetRagCorpusRequest|null|undefined,
          {}|null|undefined>): void;
  getRagCorpus(
      request: protos.google.cloud.aiplatform.v1.IGetRagCorpusRequest,
      callback: Callback<
 ...
 *   Format:
 *   `projects/{project}/locations/{location}/ragCorpora/{rag_corpus}`
 * @param {google.cloud.aiplatform.v1.RagFile} request.ragFile
 *   Required. The RagFile to upload.
 * @param {google.cloud.aiplatform.v1.UploadRagFileConfig} request.uploadRagFileConfig
 *   Required. The config for the RagFiles to be uploaded into the RagCorpus.
 *   {@link protos.google.cloud.aiplatform.v1.VertexRagDataService.UploadRagFile|VertexRagDataService.UploadRagFile}.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1.UploadRagFileResponse|UploadRagFileResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/vertex_rag_data_service.upload_rag_file.js</caption>
 * region_tag:aiplatform_v1_generated_VertexRagDataService_UploadRagFile_async
 */
  uploadRagFile(
      request?: protos.google.cloud.aiplatform.v1.IUploadRagFileRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IUploadRagFileResponse,
        protos.google.cloud.aiplatform.v1.IUploadRagFileRequest|undefined, {}|undefined
      ]>;
  uploadRagFile(
      request: protos.google.cloud.aiplatform.v1.IUploadRagFileRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IUploadRagFileResponse,
          protos.google.cloud.aiplatform.v1.IUploadRagFileRequest|null|undefined,
          {}|null|undefined>): void;
  uploadRagFile(
      request: protos.google.cloud.aiplatform.v1.IUploadRagFileRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1.RagFile|RagFile}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/vertex_rag_data_service.get_rag_file.js</caption>
 * region_tag:aiplatform_v1_generated_VertexRagDataService_GetRagFile_async
 */
  getRagFile(
      request?: protos.google.cloud.aiplatform.v1.IGetRagFileRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IRagFile,
        protos.google.cloud.aiplatform.v1.IGetRagFileRequest|undefined, {}|undefined
      ]>;
  getRagFile(
      request: protos.google.cloud.aiplatform.v1.IGetRagFileRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IRagFile,
          protos.google.cloud.aiplatform.v1.IGetRagFileRequest|null|undefined,
          {}|null|undefined>): void;
  getRagFile(
      request: protos.google.cloud.aiplatform.v1.IGetRagFileRequest,
      callback: Callback<
 ...
 * @param {google.cloud.aiplatform.v1.RagCorpus} request.ragCorpus
 ...
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/vertex_rag_data_service.create_rag_corpus.js</caption>
 * region_tag:aiplatform_v1_generated_VertexRagDataService_CreateRagCorpus_async
 */
  createRagCorpus(
      request?: protos.google.cloud.aiplatform.v1.ICreateRagCorpusRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1.IRagCorpus, protos.google.cloud.aiplatform.v1.ICreateRagCorpusOperationMetadata>,
 ...
 * region_tag:aiplatform_v1_generated_VertexRagDataService_CreateRagCorpus_async
 */
  async checkCreateRagCorpusProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.RagCorpus, protos.google.cloud.aiplatform.v1.CreateRagCorpusOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.RagCorpus, protos.google.cloud.aiplatform.v1.CreateRagCorpusOperationMetadata>;
  }
/**
 * Updates a RagCorpus.
 *
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/vertex_rag_data_service.update_rag_corpus.js</caption>
 * region_tag:aiplatform_v1_generated_VertexRagDataService_UpdateRagCorpus_async
 */
  updateRagCorpus(
      request?: protos.google.cloud.aiplatform.v1.IUpdateRagCorpusRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1.IRagCorpus, protos.google.cloud.aiplatform.v1.IUpdateRagCorpusOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  updateRagCorpus(
      request: protos.google.cloud.aiplatform.v1.IUpdateRagCorpusRequest,
 ...
 * region_tag:aiplatform_v1_generated_VertexRagDataService_UpdateRagCorpus_async
 */
  async checkUpdateRagCorpusProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.RagCorpus, protos.google.cloud.aiplatform.v1.UpdateRagCorpusOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.RagCorpus, protos.google.cloud.aiplatform.v1.UpdateRagCorpusOperationMetadata>;
  }
/**
 * Deletes a RagCorpus.
 *
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/vertex_rag_data_service.delete_rag_corpus.js</caption>
 * region_tag:aiplatform_v1_generated_VertexRagDataService_DeleteRagCorpus_async
 */
  deleteRagCorpus(
      request?: protos.google.cloud.aiplatform.v1.IDeleteRagCorpusRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1_generated_VertexRagDataService_DeleteRagCorpus_async
 */
  async checkDeleteRagCorpusProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1.DeleteOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
 ...
 *   Format:
 *   `projects/{project}/locations/{location}/ragCorpora/{rag_corpus}`
 * @param {google.cloud.aiplatform.v1.ImportRagFilesConfig} request.importRagFilesConfig
 *   Required. The config for the RagFiles to be synced and imported into the
 *   RagCorpus.
 *   {@link protos.google.cloud.aiplatform.v1.VertexRagDataService.ImportRagFiles|VertexRagDataService.ImportRagFiles}.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/vertex_rag_data_service.import_rag_files.js</caption>
 * region_tag:aiplatform_v1_generated_VertexRagDataService_ImportRagFiles_async
 */
  importRagFiles(
      request?: protos.google.cloud.aiplatform.v1.IImportRagFilesRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1.IImportRagFilesResponse, protos.google.cloud.aiplatform.v1.IImportRagFilesOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  importRagFiles(
      request: protos.google.cloud.aiplatform.v1.IImportRagFilesRequest,
 ...
 * region_tag:aiplatform_v1_generated_VertexRagDataService_ImportRagFiles_async
 */
  async checkImportRagFilesProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.ImportRagFilesResponse, protos.google.cloud.aiplatform.v1.ImportRagFilesOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.ImportRagFilesResponse, protos.google.cloud.aiplatform.v1.ImportRagFilesOperationMetadata>;
  }
/**
 * Deletes a RagFile.
 *
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/vertex_rag_data_service.delete_rag_file.js</caption>
 * region_tag:aiplatform_v1_generated_VertexRagDataService_DeleteRagFile_async
 */
  deleteRagFile(
      request?: protos.google.cloud.aiplatform.v1.IDeleteRagFileRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1.IDeleteOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
 ...
 * region_tag:aiplatform_v1_generated_VertexRagDataService_DeleteRagFile_async
 */
  async checkDeleteRagFileProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1.DeleteOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
 ...
 *   {@link protos.google.cloud.aiplatform.v1.ListRagCorporaResponse.next_page_token|ListRagCorporaResponse.next_page_token}
 *   of the previous
 *   {@link protos.google.cloud.aiplatform.v1.VertexRagDataService.ListRagCorpora|VertexRagDataService.ListRagCorpora}
 *   call.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.aiplatform.v1.RagCorpus|RagCorpus}.
 ...
 */
  listRagCorpora(
      request?: protos.google.cloud.aiplatform.v1.IListRagCorporaRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IRagCorpus[],
  ...
  listRagCorpora(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.aiplatform.v1.IListRagCorporaResponse|null|undefined,
          protos.google.cloud.aiplatform.v1.IRagCorpus>): void;
  listRagCorpora(
      request: protos.google.cloud.aiplatform.v1.IListRagCorporaRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1.IListRagCorporaRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1.RagCorpus|RagCorpus} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.cloud.aiplatform.v1.RagCorpus|RagCorpus}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/vertex_rag_data_service.list_rag_corpora.js</caption>
 * region_tag:aiplatform_v1_generated_VertexRagDataService_ListRagCorpora_async
 */
  listRagCorporaAsync(
      request?: protos.google.cloud.aiplatform.v1.IListRagCorporaRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1.IRagCorpus>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listRagCorpora.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1.IRagCorpus>;
  }
 /**
 ...
 *   Optional. The standard list page token.
 *   Typically obtained via
 *   {@link protos.google.cloud.aiplatform.v1.ListRagFilesResponse.next_page_token|ListRagFilesResponse.next_page_token}
 *   of the previous
 *   {@link protos.google.cloud.aiplatform.v1.VertexRagDataService.ListRagFiles|VertexRagDataService.ListRagFiles}
 *   call.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.aiplatform.v1.RagFile|RagFile}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 */
  listRagFiles(
      request?: protos.google.cloud.aiplatform.v1.IListRagFilesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IRagFile[],
  ...
  listRagFiles(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.aiplatform.v1.IListRagFilesResponse|null|undefined,
          protos.google.cloud.aiplatform.v1.IRagFile>): void;
  listRagFiles(
      request: protos.google.cloud.aiplatform.v1.IListRagFilesRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1.IListRagFilesRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1.RagFile|RagFile} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `listRagFilesAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
 *   When you iterate the returned iterable, each element will be an object representing
 *   {@link protos.google.cloud.aiplatform.v1.RagFile|RagFile}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/vertex_rag_data_service.list_rag_files.js</caption>
 * region_tag:aiplatform_v1_generated_VertexRagDataService_ListRagFiles_async
 */
  listRagFilesAsync(
      request?: protos.google.cloud.aiplatform.v1.IListRagFilesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1.IRagFile>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listRagFiles.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1.IRagFile>;
  }
/**
