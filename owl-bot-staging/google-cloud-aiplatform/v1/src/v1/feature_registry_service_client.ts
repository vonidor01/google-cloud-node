...
export class FeatureRegistryServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createFeatureGroupResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.FeatureGroup') as gax.protobuf.Type;
    const createFeatureGroupMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.CreateFeatureGroupOperationMetadata') as gax.protobuf.Type;
    const updateFeatureGroupResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.FeatureGroup') as gax.protobuf.Type;
    const updateFeatureGroupMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.UpdateFeatureGroupOperationMetadata') as gax.protobuf.Type;
    ...
    const updateFeatureMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.UpdateFeatureOperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.FeatureRegistryService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.featureRegistryServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.FeatureRegistryService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1.FeatureRegistryService,
 ...
 */
  getFeatureGroup(
      request?: protos.google.cloud.aiplatform.v1.IGetFeatureGroupRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IFeatureGroup,
        protos.google.cloud.aiplatform.v1.IGetFeatureGroupRequest|undefined, {}|undefined
      ]>;
  getFeatureGroup(
      request: protos.google.cloud.aiplatform.v1.IGetFeatureGroupRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IFeatureGroup,
          protos.google.cloud.aiplatform.v1.IGetFeatureGroupRequest|null|undefined,
          {}|null|undefined>): void;
  getFeatureGroup(
      request: protos.google.cloud.aiplatform.v1.IGetFeatureGroupRequest,
      callback: Callback<
 ...
 */
  createFeatureGroup(
      request?: protos.google.cloud.aiplatform.v1.ICreateFeatureGroupRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1_generated_FeatureRegistryService_CreateFeatureGroup_async
 */
  async checkCreateFeatureGroupProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.FeatureGroup, protos.google.cloud.aiplatform.v1.CreateFeatureGroupOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.FeatureGroup, protos.google.cloud.aiplatform.v1.CreateFeatureGroupOperationMetadata>;
  }
/**
 ...
 */
  updateFeatureGroup(
      request?: protos.google.cloud.aiplatform.v1.IUpdateFeatureGroupRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1_generated_FeatureRegistryService_UpdateFeatureGroup_async
 */
  async checkUpdateFeatureGroupProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.FeatureGroup, protos.google.cloud.aiplatform.v1.UpdateFeatureGroupOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.FeatureGroup, protos.google.cloud.aiplatform.v1.UpdateFeatureGroupOperationMetadata>;
  }
/**
 ...
 */
  deleteFeatureGroup(
      request?: protos.google.cloud.aiplatform.v1.IDeleteFeatureGroupRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1_generated_FeatureRegistryService_DeleteFeatureGroup_async
 */
  async checkDeleteFeatureGroupProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1.DeleteOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
 ...
 * region_tag:aiplatform_v1_generated_FeatureRegistryService_UpdateFeature_async
 */
  async checkUpdateFeatureProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.Feature, protos.google.cloud.aiplatform.v1.UpdateFeatureOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.Feature, protos.google.cloud.aiplatform.v1.UpdateFeatureOperationMetadata>;
  }
/**
 ...
 */
  listFeatureGroups(
      request?: protos.google.cloud.aiplatform.v1.IListFeatureGroupsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IFeatureGroup[],
  ...
  listFeatureGroups(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.aiplatform.v1.IListFeatureGroupsResponse|null|undefined,
          protos.google.cloud.aiplatform.v1.IFeatureGroup>): void;
  listFeatureGroups(
      request: protos.google.cloud.aiplatform.v1.IListFeatureGroupsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1.IListFeatureGroupsRequest,
 ...
 */
  listFeatureGroupsAsync(
      request?: protos.google.cloud.aiplatform.v1.IListFeatureGroupsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1.IFeatureGroup>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listFeatureGroups.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1.IFeatureGroup>;
  }
 /**
