...
function main(parent, query) {
  // [START aiplatform_v1_generated_VertexRagService_RetrieveContexts_async]
  /**
  ...
  async function callRetrieveContexts() {
    // Construct request
    const request = {
      parent,
      query,
    ...
    // Run request
    const response = await aiplatformClient.retrieveContexts(request);
    console.log(response);
  }

  callRetrieveContexts();
