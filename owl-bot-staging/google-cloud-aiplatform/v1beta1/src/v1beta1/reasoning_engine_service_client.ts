 ...
 */
import * as gapicConfig from './reasoning_engine_service_client_config.json';
 ...
 * @memberof v1beta1
 */
export class ReasoningEngineServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof ReasoningEngineServiceClient;
    ...
    this.descriptors.page = {
      listReasoningEngines:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'reasoningEngines')
    };
    ...
    const createReasoningEngineResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.ReasoningEngine') as gax.protobuf.Type;
    const createReasoningEngineMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.CreateReasoningEngineOperationMetadata') as gax.protobuf.Type;
    const updateReasoningEngineResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.ReasoningEngine') as gax.protobuf.Type;
    const updateReasoningEngineMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.UpdateReasoningEngineOperationMetadata') as gax.protobuf.Type;
    const deleteReasoningEngineResponse = protoFilesRoot.lookup(
      '.google.protobuf.Empty') as gax.protobuf.Type;
    const deleteReasoningEngineMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      createReasoningEngine: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createReasoningEngineResponse.decode.bind(createReasoningEngineResponse),
        createReasoningEngineMetadata.decode.bind(createReasoningEngineMetadata)),
      updateReasoningEngine: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateReasoningEngineResponse.decode.bind(updateReasoningEngineResponse),
        updateReasoningEngineMetadata.decode.bind(updateReasoningEngineMetadata)),
      deleteReasoningEngine: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteReasoningEngineResponse.decode.bind(deleteReasoningEngineResponse),
        deleteReasoningEngineMetadata.decode.bind(deleteReasoningEngineMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.ReasoningEngineService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.reasoningEngineServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.ReasoningEngineService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1beta1.ReasoningEngineService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const reasoningEngineServiceStubMethods =
        ['createReasoningEngine', 'getReasoningEngine', 'listReasoningEngines', 'updateReasoningEngine', 'deleteReasoningEngine'];
 ...
 */
  getReasoningEngine(
      request?: protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IReasoningEngine,
        protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRequest|undefined, {}|undefined
      ]>;
  getReasoningEngine(
      request: protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IReasoningEngine,
          protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRequest|null|undefined,
          {}|null|undefined>): void;
  getReasoningEngine(
      request: protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRequest,
      callback: Callback<
 ...
 */
  createReasoningEngine(
      request?: protos.google.cloud.aiplatform.v1beta1.ICreateReasoningEngineRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1beta1_generated_ReasoningEngineService_CreateReasoningEngine_async
 */
  async checkCreateReasoningEngineProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.ReasoningEngine, protos.google.cloud.aiplatform.v1beta1.CreateReasoningEngineOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.ReasoningEngine, protos.google.cloud.aiplatform.v1beta1.CreateReasoningEngineOperationMetadata>;
  }
/**
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/reasoning_engine_service.update_reasoning_engine.js</caption>
 * region_tag:aiplatform_v1beta1_generated_ReasoningEngineService_UpdateReasoningEngine_async
 */
  updateReasoningEngine(
      request?: protos.google.cloud.aiplatform.v1beta1.IUpdateReasoningEngineRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1beta1.IReasoningEngine, protos.google.cloud.aiplatform.v1beta1.IUpdateReasoningEngineOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  updateReasoningEngine(
      request: protos.google.cloud.aiplatform.v1beta1.IUpdateReasoningEngineRequest,
 ...
 * region_tag:aiplatform_v1beta1_generated_ReasoningEngineService_UpdateReasoningEngine_async
 */
  async checkUpdateReasoningEngineProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.ReasoningEngine, protos.google.cloud.aiplatform.v1beta1.UpdateReasoningEngineOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateReasoningEngine, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.ReasoningEngine, protos.google.cloud.aiplatform.v1beta1.UpdateReasoningEngineOperationMetadata>;
  }
/**
 ...
 */
  deleteReasoningEngine(
      request?: protos.google.cloud.aiplatform.v1beta1.IDeleteReasoningEngineRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1beta1_generated_ReasoningEngineService_DeleteReasoningEngine_async
 */
  async checkDeleteReasoningEngineProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
 ...
 */
  listReasoningEngines(
      request?: protos.google.cloud.aiplatform.v1beta1.IListReasoningEnginesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IReasoningEngine[],
  ...
  listReasoningEngines(
      ...
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListReasoningEnginesRequest,
          protos.google.cloud.aiplatform.v1beta1.IListReasoningEnginesResponse|null|undefined,
          protos.google.cloud.aiplatform.v1beta1.IReasoningEngine>): void;
  listReasoningEngines(
      request: protos.google.cloud.aiplatform.v1beta1.IListReasoningEnginesRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListReasoningEnginesRequest,
 ...
 */
  listReasoningEnginesAsync(
      request?: protos.google.cloud.aiplatform.v1beta1.IListReasoningEnginesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IReasoningEngine>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listReasoningEngines.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IReasoningEngine>;
  }
/**
