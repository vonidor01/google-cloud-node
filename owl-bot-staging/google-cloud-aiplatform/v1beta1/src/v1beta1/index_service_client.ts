...
export class IndexServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const updateIndexMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.UpdateIndexOperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.IndexService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.indexServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.IndexService') :
 ...
 */
  getIndex(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1beta1.IGetIndexRequest|undefined, {}|undefined
      ]>;
  getIndex(
      request: protos.google.cloud.aiplatform.v1beta1.IGetIndexRequest,
      options: CallOptions,
 ...
 */
  upsertDatapoints(
      request?: protos.google.cloud.aiplatform.v1beta1.IUpsertDatapointsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IUpsertDatapointsResponse,
        protos.google.cloud.aiplatform.v1beta1.IUpsertDatapointsRequest|undefined, {}|undefined
      ]>;
  upsertDatapoints(
      request: protos.google.cloud.aiplatform.v1beta1.IUpsertDatapointsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IUpsertDatapointsResponse,
          protos.google.cloud.aiplatform.v1beta1.IUpsertDatapointsRequest|null|undefined,
          {}|null|undefined>): void;
  upsertDatapoints(
      request: protos.google.cloud.aiplatform.v1beta1.IUpsertDatapointsRequest,
      callback: Callback<
 ...
 */
  removeDatapoints(
      request?: protos.google.cloud.aiplatform.v1beta1.IRemoveDatapointsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IRemoveDatapointsResponse,
        protos.google.cloud.aiplatform.v1beta1.IRemoveDatapointsRequest|undefined, {}|undefined
      ]>;
  removeDatapoints(
      request: protos.google.cloud.aiplatform.v1beta1.IRemoveDatapointsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IRemoveDatapointsResponse,
          protos.google.cloud.aiplatform.v1beta1.IRemoveDatapointsRequest|null|undefined,
          {}|null|undefined>): void;
  removeDatapoints(
      request: protos.google.cloud.aiplatform.v1beta1.IRemoveDatapointsRequest,
      callback: Callback<
 ...
 */
  listIndexesAsync(
      request?: protos.google.cloud.aiplatform.v1beta1.IListIndexesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IIndex>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listIndexes.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IIndex>;
  }
/**
