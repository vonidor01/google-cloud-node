...
export class DeploymentResourcePoolServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const updateDeploymentResourcePoolMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.UpdateDeploymentResourcePoolOperationMetadata') as gax.protobuf.Type;
 ...
 */
  updateDeploymentResourcePool(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1beta1.IDeploymentResourcePool, protos.google.cloud.aiplatform.v1beta1.IUpdateDeploymentResourcePoolOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  updateDeploymentResourcePool(
      request: protos.google.cloud.aiplatform.v1beta1.IUpdateDeploymentResourcePoolRequest,
 ...
 * region_tag:aiplatform_v1beta1_generated_DeploymentResourcePoolService_UpdateDeploymentResourcePool_async
 */
  async checkUpdateDeploymentResourcePoolProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.DeploymentResourcePool, protos.google.cloud.aiplatform.v1beta1.UpdateDeploymentResourcePoolOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.DeploymentResourcePool, protos.google.cloud.aiplatform.v1beta1.UpdateDeploymentResourcePoolOperationMetadata>;
  }
/**
