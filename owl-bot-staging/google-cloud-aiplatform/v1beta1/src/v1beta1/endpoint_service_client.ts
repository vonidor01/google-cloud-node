...
export class EndpointServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const updateEndpointLongRunningMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.UpdateEndpointOperationMetadata') as gax.protobuf.Type;
    ...
    const mutateDeployedModelResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.MutateDeployedModelResponse') as gax.protobuf.Type;
    const mutateDeployedModelMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.MutateDeployedModelOperationMetadata') as gax.protobuf.Type;
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/endpoint_service.update_endpoint_long_running.js</caption>
 * region_tag:aiplatform_v1beta1_generated_EndpointService_UpdateEndpointLongRunning_async
 */
  updateEndpointLongRunning(
      request?: protos.google.cloud.aiplatform.v1beta1.IUpdateEndpointLongRunningRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1beta1.IEndpoint, protos.google.cloud.aiplatform.v1beta1.IUpdateEndpointOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  updateEndpointLongRunning(
      request: protos.google.cloud.aiplatform.v1beta1.IUpdateEndpointLongRunningRequest,
  ...
  updateEndpointLongRunning(
    ...
    this.initialize();
    return this.innerApiCalls.updateEndpointLongRunning(request, options, callback);
  }
/**
 ...
 * region_tag:aiplatform_v1beta1_generated_EndpointService_UpdateEndpointLongRunning_async
 */
  async checkUpdateEndpointLongRunningProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.Endpoint, protos.google.cloud.aiplatform.v1beta1.UpdateEndpointOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.Endpoint, protos.google.cloud.aiplatform.v1beta1.UpdateEndpointOperationMetadata>;
  }
/**
 * Deletes an Endpoint.
 *
 ...
 */
  mutateDeployedModel(
      request?: protos.google.cloud.aiplatform.v1beta1.IMutateDeployedModelRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1beta1_generated_EndpointService_MutateDeployedModel_async
 */
  async checkMutateDeployedModelProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.MutateDeployedModelResponse, protos.google.cloud.aiplatform.v1beta1.MutateDeployedModelOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.MutateDeployedModelResponse, protos.google.cloud.aiplatform.v1beta1.MutateDeployedModelOperationMetadata>;
  }
 /**
