...
describe('v1.NotebookServiceClient', () => {
  ...
  describe('getNotebookExecutionJob', () => {
    it('invokes getNotebookExecutionJob without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getNotebookExecutionJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getNotebookExecutionJob as SinonStub
    ...
    it('invokes getNotebookExecutionJob without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getNotebookExecutionJob(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.INotebookExecutionJob | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getNotebookExecutionJob with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getNotebookExecutionJob = stubSimpleCall(
        undefined,
        expectedError
      );
      await assert.rejects(
        client.getNotebookExecutionJob(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.getNotebookExecutionJob as SinonStub
  ...
  describe('stopNotebookRuntime', () => {
    it('invokes stopNotebookRuntime without error', async () => {
      ...
      client.innerApiCalls.stopNotebookRuntime =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.stopNotebookRuntime(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.stopNotebookRuntime as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.stopNotebookRuntime as SinonStub
    ...
    it('invokes stopNotebookRuntime with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.stopNotebookRuntime = stubLongRunningCall(
        undefined,
        expectedError
      );
    ...
    it('invokes checkStopNotebookRuntimeProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkStopNotebookRuntimeProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkStopNotebookRuntimeProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkStopNotebookRuntimeProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createNotebookExecutionJob', () => {
    it('invokes createNotebookExecutionJob without error', async () => {
      ...
      client.innerApiCalls.createNotebookExecutionJob =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createNotebookExecutionJob(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createNotebookExecutionJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createNotebookExecutionJob as SinonStub
        ...
        client.createNotebookExecutionJob(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.aiplatform.v1.ICreateNotebookExecutionJobOperationMetadata
            > | null
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes createNotebookExecutionJob with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createNotebookExecutionJob = stubLongRunningCall(
        undefined,
        expectedError
      );
      await assert.rejects(
        client.createNotebookExecutionJob(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.createNotebookExecutionJob as SinonStub
    ...
    it('invokes checkCreateNotebookExecutionJobProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateNotebookExecutionJobProgress(
          expectedResponse.name
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateNotebookExecutionJobProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateNotebookExecutionJobProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteNotebookExecutionJob', () => {
    it('invokes deleteNotebookExecutionJob without error', async () => {
      ...
      client.innerApiCalls.deleteNotebookExecutionJob =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteNotebookExecutionJob(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteNotebookExecutionJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteNotebookExecutionJob as SinonStub
    ...
    it('invokes deleteNotebookExecutionJob with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteNotebookExecutionJob = stubLongRunningCall(
        undefined,
        expectedError
      );
      await assert.rejects(
        client.deleteNotebookExecutionJob(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.deleteNotebookExecutionJob as SinonStub
    ...
    it('invokes checkDeleteNotebookExecutionJobProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteNotebookExecutionJobProgress(
          expectedResponse.name
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteNotebookExecutionJobProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteNotebookExecutionJobProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listNotebookExecutionJobs', () => {
    it('invokes listNotebookExecutionJobs without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listNotebookExecutionJobs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listNotebookExecutionJobs as SinonStub
    ...
    it('invokes listNotebookExecutionJobs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listNotebookExecutionJobs = stubSimpleCall(
        undefined,
        expectedError
      );
      await assert.rejects(
        client.listNotebookExecutionJobs(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.listNotebookExecutionJobs as SinonStub
    ...
    it('invokes listNotebookExecutionJobsStream without error', async () => {
      ...
      client.descriptors.page.listNotebookExecutionJobs.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1.NotebookExecutionJob
          ) => {
            responses.push(response);
          }
        );
      ...
      assert(
        (
          client.descriptors.page.listNotebookExecutionJobs
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listNotebookExecutionJobs, request)
      );
      assert(
        (
          client.descriptors.page.listNotebookExecutionJobs
    ...
    it('uses async iteration with listNotebookExecutionJobs without error', async () => {
      ...
      client.descriptors.page.listNotebookExecutionJobs.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
