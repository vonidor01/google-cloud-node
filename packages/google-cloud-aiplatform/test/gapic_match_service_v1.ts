  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          matchserviceModule.v1.MatchServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          matchserviceModule.v1.MatchServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new matchserviceModule.v1.MatchServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes findNeighbors without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.findNeighbors(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IFindNeighborsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes readIndexDatapoints without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.readIndexDatapoints(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IReadIndexDatapointsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
