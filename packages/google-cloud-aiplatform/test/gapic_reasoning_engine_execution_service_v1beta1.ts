...
describe('v1beta1.ReasoningEngineExecutionServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          reasoningengineexecutionserviceModule.v1beta1
            .ReasoningEngineExecutionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          reasoningengineexecutionserviceModule.v1beta1
            .ReasoningEngineExecutionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        reasoningengineexecutionserviceModule.v1beta1
          .ReasoningEngineExecutionServiceClient.port;
      assert(port);
  ...
  describe('queryReasoningEngine', () => {
    it('invokes queryReasoningEngine without error', async () => {
      ...
      client.innerApiCalls.queryReasoningEngine =
        stubSimpleCall(expectedResponse);
      const [response] = await client.queryReasoningEngine(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.queryReasoningEngine as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes queryReasoningEngine without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.queryReasoningEngine(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes queryReasoningEngine with error', async () => {
      ...
      client.innerApiCalls.queryReasoningEngine = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('streamQueryReasoningEngine', () => {
    it('invokes streamQueryReasoningEngine without error', async () => {
      ...
      client.innerApiCalls.streamQueryReasoningEngine =
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.streamQueryReasoningEngine as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.streamQueryReasoningEngine as SinonStub
    ...
    it('invokes streamQueryReasoningEngine with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.streamQueryReasoningEngine = stubServerStreamingCall(
        undefined,
        expectedError
      );
      const stream = client.streamQueryReasoningEngine(request);
