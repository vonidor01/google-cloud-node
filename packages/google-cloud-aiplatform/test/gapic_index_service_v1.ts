  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          indexserviceModule.v1.IndexServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          indexserviceModule.v1.IndexServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new indexserviceModule.v1.IndexServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getIndex without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getIndex(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IIndex | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listIndexes', () => {
    ...
    it('invokes listIndexesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1.Index) => {
