...
describe('v1beta1.VertexRagServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new vertexragserviceModule.v1beta1.VertexRagServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          vertexragserviceModule.v1beta1.VertexRagServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          vertexragserviceModule.v1beta1.VertexRagServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes retrieveContexts without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.retrieveContexts(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IRetrieveContextsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes augmentPrompt without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.augmentPrompt(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IAugmentPromptResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes corroborateContent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.corroborateContent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.ICorroborateContentResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
