...
describe('v1.FeatureOnlineStoreAdminServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new featureonlinestoreadminserviceModule.v1.FeatureOnlineStoreAdminServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          featureonlinestoreadminserviceModule.v1
    ...
    it('has port', () => {
      const port =
        featureonlinestoreadminserviceModule.v1
          .FeatureOnlineStoreAdminServiceClient.port;
      assert(port);
  ...
  describe('getFeatureOnlineStore', () => {
    it('invokes getFeatureOnlineStore without error', async () => {
      ...
      client.innerApiCalls.getFeatureOnlineStore =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getFeatureOnlineStore(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getFeatureOnlineStore as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getFeatureOnlineStore without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFeatureOnlineStore(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IFeatureOnlineStore | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getFeatureOnlineStore with error', async () => {
      ...
      await assert.rejects(
        client.getFeatureOnlineStore(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.getFeatureOnlineStore as SinonStub
  ...
  describe('getFeatureView', () => {
    it('invokes getFeatureView without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getFeatureView as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getFeatureView as SinonStub
    ...
    it('invokes getFeatureView without error using callback', async () => {
      ...
      client.innerApiCalls.getFeatureView =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getFeatureView(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IFeatureView | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('syncFeatureView', () => {
    it('invokes syncFeatureView without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.syncFeatureView as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.syncFeatureView as SinonStub
    ...
    it('invokes syncFeatureView without error using callback', async () => {
      ...
      client.innerApiCalls.syncFeatureView =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.syncFeatureView(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.ISyncFeatureViewResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getFeatureViewSync', () => {
    it('invokes getFeatureViewSync without error', async () => {
      ...
      client.innerApiCalls.getFeatureViewSync =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getFeatureViewSync(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getFeatureViewSync as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getFeatureViewSync as SinonStub
    ...
    it('invokes getFeatureViewSync without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFeatureViewSync(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IFeatureViewSync | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createFeatureOnlineStore', () => {
    it('invokes createFeatureOnlineStore without error', async () => {
      ...
      client.innerApiCalls.createFeatureOnlineStore =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createFeatureOnlineStore(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createFeatureOnlineStore as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createFeatureOnlineStore as SinonStub
    ...
    it('invokes createFeatureOnlineStore with call error', async () => {
      ...
      await assert.rejects(
        client.createFeatureOnlineStore(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.createFeatureOnlineStore as SinonStub
    ...
    it('invokes checkCreateFeatureOnlineStoreProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkCreateFeatureOnlineStoreProgress(
    ...
    it('invokes checkCreateFeatureOnlineStoreProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateFeatureOnlineStoreProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateFeatureOnlineStore', () => {
    it('invokes updateFeatureOnlineStore without error', async () => {
      ...
      client.innerApiCalls.updateFeatureOnlineStore =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateFeatureOnlineStore(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateFeatureOnlineStore as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateFeatureOnlineStore as SinonStub
    ...
    it('invokes updateFeatureOnlineStore with call error', async () => {
      ...
      await assert.rejects(
        client.updateFeatureOnlineStore(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.updateFeatureOnlineStore as SinonStub
    ...
    it('invokes checkUpdateFeatureOnlineStoreProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateFeatureOnlineStoreProgress(
          expectedResponse.name
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateFeatureOnlineStoreProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateFeatureOnlineStoreProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteFeatureOnlineStore', () => {
    it('invokes deleteFeatureOnlineStore without error', async () => {
      ...
      client.innerApiCalls.deleteFeatureOnlineStore =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteFeatureOnlineStore(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteFeatureOnlineStore as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteFeatureOnlineStore as SinonStub
    ...
    it('invokes deleteFeatureOnlineStore with call error', async () => {
      ...
      await assert.rejects(
        client.deleteFeatureOnlineStore(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.deleteFeatureOnlineStore as SinonStub
    ...
    it('invokes checkDeleteFeatureOnlineStoreProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteFeatureOnlineStoreProgress(
          expectedResponse.name
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteFeatureOnlineStoreProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteFeatureOnlineStoreProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createFeatureView', () => {
    it('invokes createFeatureView without error', async () => {
      ...
      client.innerApiCalls.createFeatureView =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createFeatureView(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createFeatureView as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createFeatureView as SinonStub
    ...
    it('invokes checkCreateFeatureViewProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkCreateFeatureViewProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateFeatureViewProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateFeatureViewProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateFeatureView', () => {
    it('invokes updateFeatureView without error', async () => {
      ...
      client.innerApiCalls.updateFeatureView =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateFeatureView(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateFeatureView as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateFeatureView as SinonStub
    ...
    it('invokes checkUpdateFeatureViewProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkUpdateFeatureViewProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateFeatureViewProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateFeatureViewProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteFeatureView', () => {
    it('invokes deleteFeatureView without error', async () => {
      ...
      client.innerApiCalls.deleteFeatureView =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteFeatureView(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteFeatureView as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteFeatureView as SinonStub
    ...
    it('invokes checkDeleteFeatureViewProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkDeleteFeatureViewProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteFeatureViewProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteFeatureViewProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listFeatureOnlineStores', () => {
    it('invokes listFeatureOnlineStores without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listFeatureOnlineStores as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listFeatureOnlineStores as SinonStub
    ...
    it('invokes listFeatureOnlineStores with error', async () => {
      ...
      await assert.rejects(
        client.listFeatureOnlineStores(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.listFeatureOnlineStores as SinonStub
    ...
    it('invokes listFeatureOnlineStoresStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1.FeatureOnlineStore) => {
      ...
      assert(
        (
          client.descriptors.page.listFeatureOnlineStores
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listFeatureOnlineStores, request)
      );
      assert(
        (
          client.descriptors.page.listFeatureOnlineStores
  ...
  describe('listFeatureViews', () => {
    it('invokes listFeatureViews without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listFeatureViews as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listFeatureViews as SinonStub
    ...
    it('invokes listFeatureViews without error using callback', async () => {
      ...
      client.innerApiCalls.listFeatureViews =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listFeatureViewsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1.FeatureView) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listFeatureViews.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listFeatureViews, request)
      );
      assert(
        (client.descriptors.page.listFeatureViews.createStream as SinonStub)
          .getCall(0)
  ...
  describe('listFeatureViewSyncs', () => {
    it('invokes listFeatureViewSyncs without error', async () => {
      ...
      client.innerApiCalls.listFeatureViewSyncs =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listFeatureViewSyncs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listFeatureViewSyncs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listFeatureViewSyncs as SinonStub
    ...
    it('invokes listFeatureViewSyncsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1.FeatureViewSync) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listFeatureViewSyncs.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listFeatureViewSyncs, request)
      );
      assert(
        (client.descriptors.page.listFeatureViewSyncs.createStream as SinonStub)
          .getCall(0)
