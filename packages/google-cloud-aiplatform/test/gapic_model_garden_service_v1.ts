  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          modelgardenserviceModule.v1.ModelGardenServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          modelgardenserviceModule.v1.ModelGardenServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new modelgardenserviceModule.v1.ModelGardenServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'aiplatform.example.com');
          if (saved) {
    ...
    it('invokes getPublisherModel without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPublisherModel(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IPublisherModel | null
          ) => {
            if (err) {
              reject(err);
            } else {
