...
describe('v1.LlmUtilityServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          llmutilityserviceModule.v1.LlmUtilityServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          llmutilityserviceModule.v1.LlmUtilityServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new llmutilityserviceModule.v1.LlmUtilityServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'aiplatform.example.com');
          if (saved) {
    ...
    it('invokes countTokens without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.countTokens(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.ICountTokensResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('computeTokens', () => {
    it('invokes computeTokens without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.computeTokens as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.computeTokens as SinonStub
    ...
    it('invokes computeTokens without error using callback', async () => {
      ...
      client.innerApiCalls.computeTokens =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.computeTokens(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IComputeTokensResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
