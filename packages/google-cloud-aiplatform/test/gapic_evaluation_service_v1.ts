  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          evaluationserviceModule.v1.EvaluationServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          evaluationserviceModule.v1.EvaluationServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new evaluationserviceModule.v1.EvaluationServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'aiplatform.example.com');
          if (saved) {
    ...
    it('invokes evaluateInstances without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.evaluateInstances(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IEvaluateInstancesResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
