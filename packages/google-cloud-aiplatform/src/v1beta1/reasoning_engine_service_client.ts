...
export class ReasoningEngineServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof ReasoningEngineServiceClient;
    if (
    ...
    this.descriptors.page = {
      listReasoningEngines: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'reasoningEngines'
      ),
    ...
    this.descriptors.longrunning = {
      createReasoningEngine: new this._gaxModule.LongrunningDescriptor(
        ...
        createReasoningEngineResponse.decode.bind(
          createReasoningEngineResponse
        ),
      ...
      updateReasoningEngine: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateReasoningEngineResponse.decode.bind(
          updateReasoningEngineResponse
        ),
      ...
      deleteReasoningEngine: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteReasoningEngineResponse.decode.bind(
          deleteReasoningEngineResponse
        ),
  ...
  getReasoningEngine(
    ...
    [
      ...
      (
        | protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  createReasoningEngine(
    ...
    [
      LROperation<
        protos.google.cloud.aiplatform.v1beta1.IReasoningEngine,
        protos.google.cloud.aiplatform.v1beta1.ICreateReasoningEngineOperationMetadata
      >,
   ...
   * region_tag:aiplatform_v1beta1_generated_ReasoningEngineService_CreateReasoningEngine_async
   */
  async checkCreateReasoningEngineProgress(
    name: string
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.ReasoningEngine,
      protos.google.cloud.aiplatform.v1beta1.CreateReasoningEngineOperationMetadata
    >
  > {
    const request =
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.createReasoningEngine,
  ...
  updateReasoningEngine(
    ...
    [
      LROperation<
        protos.google.cloud.aiplatform.v1beta1.IReasoningEngine,
        protos.google.cloud.aiplatform.v1beta1.IUpdateReasoningEngineOperationMetadata
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined,
    ]
   ...
   * region_tag:aiplatform_v1beta1_generated_ReasoningEngineService_UpdateReasoningEngine_async
   */
  async checkUpdateReasoningEngineProgress(
    name: string
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.ReasoningEngine,
      protos.google.cloud.aiplatform.v1beta1.UpdateReasoningEngineOperationMetadata
    >
  > {
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.updateReasoningEngine,
      this._gaxModule.createDefaultBackoffSettings()
    );
    return decodeOperation as LROperation<
      protos.google.cloud.aiplatform.v1beta1.ReasoningEngine,
   ...
   * region_tag:aiplatform_v1beta1_generated_ReasoningEngineService_DeleteReasoningEngine_async
   */
  async checkDeleteReasoningEngineProgress(
    name: string
  ): Promise<
    LROperation<
  ...
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.deleteReasoningEngine,
      this._gaxModule.createDefaultBackoffSettings()
    );
    return decodeOperation as LROperation<
      protos.google.protobuf.Empty,
