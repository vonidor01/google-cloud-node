...
export class FeatureRegistryServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof FeatureRegistryServiceClient;
    if (
    ...
    this.descriptors.page = {
      listFeatureGroups: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'featureGroups'
      ),
    ...
    const updateFeatureGroupMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.UpdateFeatureGroupOperationMetadata'
    ) as gax.protobuf.Type;
  ...
  getFeatureGroup(
    ...
    callback: Callback<
      protos.google.cloud.aiplatform.v1.IFeatureGroup,
      | protos.google.cloud.aiplatform.v1.IGetFeatureGroupRequest
      | null
      | undefined,
      {} | null | undefined
    >
   ...
   * region_tag:aiplatform_v1_generated_FeatureRegistryService_CreateFeatureGroup_async
   */
  async checkCreateFeatureGroupProgress(
    name: string
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1.FeatureGroup,
      protos.google.cloud.aiplatform.v1.CreateFeatureGroupOperationMetadata
    >
  > {
    const request =
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.createFeatureGroup,
   ...
   * region_tag:aiplatform_v1_generated_FeatureRegistryService_UpdateFeatureGroup_async
   */
  async checkUpdateFeatureGroupProgress(
    name: string
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1.FeatureGroup,
      protos.google.cloud.aiplatform.v1.UpdateFeatureGroupOperationMetadata
    >
  > {
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.updateFeatureGroup,
      this._gaxModule.createDefaultBackoffSettings()
    );
    return decodeOperation as LROperation<
      protos.google.cloud.aiplatform.v1.FeatureGroup,
  ...
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.deleteFeatureGroup,
      this._gaxModule.createDefaultBackoffSettings()
    );
    return decodeOperation as LROperation<
      protos.google.protobuf.Empty,
  ...
  async checkUpdateFeatureProgress(
    ...
    LROperation<
      protos.google.cloud.aiplatform.v1.Feature,
      protos.google.cloud.aiplatform.v1.UpdateFeatureOperationMetadata
    >
  > {
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
