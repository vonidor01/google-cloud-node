...
export class VertexRagDataServiceClient {
  ...
  constructor(
    ...
    const updateRagCorpusMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.UpdateRagCorpusOperationMetadata'
    ) as gax.protobuf.Type;
  ...
  async checkCreateRagCorpusProgress(
    ...
    LROperation<
      protos.google.cloud.aiplatform.v1.RagCorpus,
  ...
  async checkImportRagFilesProgress(
    ...
    LROperation<
      protos.google.cloud.aiplatform.v1.ImportRagFilesResponse,
