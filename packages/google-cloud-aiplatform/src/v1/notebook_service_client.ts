...
export class NotebookServiceClient {
  ...
  getNotebookExecutionJob(
    ...
    [
      ...
      (
        | protos.google.cloud.aiplatform.v1.IGetNotebookExecutionJobRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  async checkCreateNotebookExecutionJobProgress(
    ...
    LROperation<
      protos.google.cloud.aiplatform.v1.NotebookExecutionJob,
      protos.google.cloud.aiplatform.v1.CreateNotebookExecutionJobOperationMetadata
    >
  > {
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
